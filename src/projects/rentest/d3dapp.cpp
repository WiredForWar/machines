...
#include "render/TTFTriangles.hpp"
...
*/
        ...
        switch (event.scanCode())
        {
            ...
            case DevKey::F1:
                camera_->colourFilter(RenColour::red());
                break;
            case DevKey::F2:
                camera_->colourFilter(RenColour::green());
                break;
            case DevKey::F3:
                camera_->colourFilter(RenColour::blue());
                break;
            case DevKey::F4:
                camera_->colourFilter(RenColour(0.2));
                break;
            case DevKey::F5:
                camera_->colourFilter(RenColour(0.5));
                break;
            case DevKey::F6:
                camera_->colourFilter(RenColour::white());
                break;
