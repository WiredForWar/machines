...
void quadraticTest()
{
    ...
    for (size_t i = 0; i < 100000; ++i)
    {
        ...
        nRoots = MexUtility::quadraticRealRoots(a, b, c, &root1, &root2);
    }
}
...
void angleTest2()
{
    ...
    for (size_t i = 0; i < 10000; ++i)
    {
        ...
        do
        {
            vec1 = MexVec2(mexRandomScalar(&r1, -1.0, 1.0), mexRandomScalar(&r1, -1.0, 1.0));
        ...
        do
        {
            vec2 = MexVec2(mexRandomScalar(&r1, -1.0, 1.0), mexRandomScalar(&r1, -1.0, 1.0));
...
void gridTest1()
{
    ...
    MexGrid2d grid(nXCells, nYCells, xSize, ySize, origin);

    WHERE;
    MexLine2d line(MexPoint2d(731.2508, 599.9916), MexPoint2d(737.8994, 600.0027));
...
MexPoint2d randomPoint2d(MexBasicRandom* pRandom)
{
    MexPoint2d point(mexRandomScalar(pRandom, -1000.0, 1000.0), mexRandomScalar(pRandom, -1000.0, 1000.0));
