...
public:
    ...
    using RaceAIs = ctl_vector<RaceAI>;
    using MineralSites = ctl_vector<MineralSite>;
    using AssemblyPoints = ctl_vector<AssemblyPoint>;
    using Miscellani = ctl_vector<Miscellanious>;
    using Constructions = ctl_vector<Construction>;
    using Machines = ctl_vector<Machine>;
    using Artefacts = ctl_vector<Artefact>;
    using Conditions = ctl_vector<Condition>;
    using Actions = ctl_vector<Action>;
...
private:
    ...
    using RacesInfo = ctl_vector<RaceInfo>;
