...
void MachCameras::initialise(W4dSceneManager* pSceneManager, W4dRoot* pRoot)
{
    ...
    MexTransform3d superHighZenithTransform(
...
MachLogMachine& MachCameras::currentMachine()
{
    ...
    MachLogMachine* pLogMachine = nullptr;
    ...
    ASSERT(pLogMachine != nullptr, logic_error());
...
void MachCameras::moveTo(const MexPoint2d& newPos)
{
    ...
    pSuperHighZenithControl_->snapTo(
        MexPoint3d(newPos.x(), newPos.y(), pSuperHighZenithCamera_->globalTransform().position().z()));
