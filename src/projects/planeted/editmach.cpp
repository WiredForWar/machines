...
void PedMachineEditor::readScnFile(PedScenarioFile& scenarioFile)
{
    ...
    for (PedScenarioFile::Machines::iterator scnMachIter = scnMachines.begin(); scnMachIter != scnMachines.end();
         ++scnMachIter)
    {
        // Create machine
...
MachPhysMachine*
PedMachineEditor::createMachine(W4dEntity& pEntity, const MexTransform3d& locTransform, const Machine& mach)
{
    // Create a new entity

    MachPhysMachine* pCurrentMachine = nullptr;
