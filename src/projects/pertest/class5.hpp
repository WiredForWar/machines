...
template <class T> Class5<T>::Class5()
{
}

template <class T> Class5<T>::Class5(PerIstream& istr)
{
    istr >> *this;
}
...
template <class T> ostream& operator<<(ostream& ostr, const Class5<T>& t)
{
    ostr << t.i_ << " " << t.d_ << endl;
...
template <class T> void perWrite(PerOstream& str, const Class5<T>& ob)
{
    str << ob.i_;
    str << ob.d_;
}

template <class T> void perRead(PerIstream& str, Class5<T>& ob)
{
    str >> ob.i_;
    str >> ob.d_;
}

template <class T> bool operator==(const Class5<T>& a, const Class5<T>& b)
{
    bool result = true;
