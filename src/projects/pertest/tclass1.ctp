...
template <class T1, class T2> TClass1<T1, T2>::~TClass1()
{
    TEST_INVARIANT;
}

template <class T1, class T2> void TClass1<T1, T2>::CLASS_INVARIANT
{
    INVARIANT(this != NULL);
}

template <class T1, class T2> ostream& operator<<(ostream& o, const TClass1<T1, T2>& t)
{
