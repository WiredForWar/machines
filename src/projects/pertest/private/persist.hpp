...
#define PER_PRIVATE_DEFINE_PERSISTENT_T(className, LIST_T, STRING_T)                                                   \
    ...
    operator>>(PerIstream& istr, className<LIST_T>*& pOb)                                                              \
...
#define PER_PRIVATE_DEFINE_PERSISTENT_INLINE_T(className, CLASS_LIST_T, LIST_T)                                        \
    template <CLASS_LIST_T>                                                                                            \
    inline PerOstream& operator<<(PerOstream& ostr, const className<LIST_T>& ob)                                       \
        PER_OBJECT_WRITE(className) template <CLASS_LIST_T>                                                            \
        inline PerIstream& operator>>(PerIstream& istr, className<LIST_T>& ob)                                         \
            PER_OBJECT_READ(className) template <CLASS_LIST_T>                                                         \
            inline PerOstream& operator<<(PerOstream& ostr, const className<LIST_T>* pOb)                              \
                PER_POINTER_WRITE(className) template <CLASS_LIST_T>                                                   \
                inline PerIstream& operator>>(PerIstream& istr, className<LIST_T>* pOb)                                \
