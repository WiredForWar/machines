...
#define PER_MEMBER_PERSISTENT_DEFAULT_ABSTRACT(className)                                                              \
    PER_PRIVATE_MEMBER_PERSISTENT_DEFAULT_ABSTRACT(className, virtual)
...
#define PER_MEMBER_PERSISTENT_ABSTRACT_INLINE(className)                                                               \
    PER_PRIVATE_MEMBER_PERSISTENT_ABSTRACT_INLINE(className, virtual)
#define PER_MEMBER_PERSISTENT_DEFAULT_ABSTRACT_INLINE(className)                                                       \
    PER_PRIVATE_MEMBER_PERSISTENT_DEFAULT_ABSTRACT_INLINE(className, virtual)
...
#define PER_MEMBER_PERSISTENT_DEFAULT_INLINE_VIRTUAL(className)                                                        \
    PER_PRIVATE_MEMBER_PERSISTENT_DEFAULT_INLINE(className, virtual)
...
#define PER_DEFINE_PERSISTENT_T5(className, T1, T2, T3, T4, T5)                                                        \
    PER_PRIVATE_DEFINE_PERSISTENT_T5(className, T1, T2, T3, T4, T5)
#define PER_DEFINE_PERSISTENT_T6(className, T1, T2, T3, T4, T5, T6)                                                    \
    PER_PRIVATE_DEFINE_PERSISTENT_T6(className, T1, T2, T3, T4, T5, T6)
#define PER_DEFINE_PERSISTENT_T7(className, T1, T2, T3, T4, T5, T6, T7)                                                \
    PER_PRIVATE_DEFINE_PERSISTENT_T7(className, T1, T2, T3, T4, T5, T6, T7)
#define PER_DEFINE_PERSISTENT_T8(className, T1, T2, T3, T4, T5, T6, T7, T8)                                            \
    PER_PRIVATE_DEFINE_PERSISTENT_T8(className, T1, T2, T3, T4, T5, T6, T7, T8)
#define PER_DEFINE_PERSISTENT_T9(className, T1, T2, T3, T4, T5, T6, T7, T8, T9)                                        \
    PER_PRIVATE_DEFINE_PERSISTENT_T9(className, T1, T2, T3, T4, T5, T6, T7, T8, T9)
#define PER_DEFINE_PERSISTENT_T10(className, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)                                  \
    PER_PRIVATE_DEFINE_PERSISTENT_T10(className, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)
...
#define PER_DEFINE_PERSISTENT_ABSTRACT_T2(className, T1, T2)                                                           \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T2(className, T1, T2)
#define PER_DEFINE_PERSISTENT_ABSTRACT_T3(className, T1, T2, T3)                                                       \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T3(className, T1, T2, T3)
#define PER_DEFINE_PERSISTENT_ABSTRACT_T4(className, T1, T2, T3, T4)                                                   \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T4(className, T1, T2, T3, T4)
#define PER_DEFINE_PERSISTENT_ABSTRACT_T5(className, T1, T2, T3, T4, T5)                                               \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T5(className, T1, T2, T3, T4, T5)
#define PER_DEFINE_PERSISTENT_ABSTRACT_T6(className, T1, T2, T3, T4, T5, T6)                                           \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T6(className, T1, T2, T3, T4, T5, T6)
#define PER_DEFINE_PERSISTENT_ABSTRACT_T7(className, T1, T2, T3, T4, T5, T6, T7)                                       \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T7(className, T1, T2, T3, T4, T5, T6, T7)
#define PER_DEFINE_PERSISTENT_ABSTRACT_T8(className, T1, T2, T3, T4, T5, T6, T7, T8)                                   \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T8(className, T1, T2, T3, T4, T5, T6, T7, T8)
#define PER_DEFINE_PERSISTENT_ABSTRACT_T9(className, T1, T2, T3, T4, T5, T6, T7, T8, T9)                               \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T9(className, T1, T2, T3, T4, T5, T6, T7, T8, T9)
#define PER_DEFINE_PERSISTENT_ABSTRACT_T10(className, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)                         \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T10(className, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)
...
#define PER_REGISTER_DERIVED_CLASS_T3(className, T1, T2, T3)                                                           \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T3(className, T1, T2, T3)
#define PER_REGISTER_DERIVED_CLASS_T4(className, T1, T2, T3, T4)                                                       \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T4(className, T1, T2, T3, T4)
#define PER_REGISTER_DERIVED_CLASS_T5(className, T1, T2, T3, T4, T5)                                                   \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T5(className, T1, T2, T3, T4, T5)
#define PER_REGISTER_DERIVED_CLASS_T6(className, T1, T2, T3, T4, T5, T6)                                               \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T6(className, T1, T2, T3, T4, T5, T6)
#define PER_REGISTER_DERIVED_CLASS_T7(className, T1, T2, T3, T4, T5, T6, T7)                                           \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T7(className, T1, T2, T3, T4, T5, T6, T7)
#define PER_REGISTER_DERIVED_CLASS_T8(className, T1, T2, T3, T4, T5, T6, T7, T8)                                       \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T8(className, T1, T2, T3, T4, T5, T6, T7, T8)
#define PER_REGISTER_DERIVED_CLASS_T9(className, T1, T2, T3, T4, T5, T6, T7, T8, T9)                                   \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T9(className, T1, T2, T3, T4, T5, T6, T7, T8, T9)
#define PER_REGISTER_DERIVED_CLASS_T10(className, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)                             \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T10(className, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)
