...
template <class T1, class T2> Class7<T1, T2>::Class7()
{
}

template <class T1, class T2> Class7<T1, T2>::Class7(PerIstream& istr)
{
    istr >> *this;
}
...
template <class T1, class T2> ostream& operator<<(ostream& ostr, const Class7<T1, T2>& t)
{
...
template <class T1, class T2> void perWrite(PerOstream& str, const Class7<T1, T2>& ob)
{
...
template <class T1, class T2> void perRead(PerIstream& str, Class7<T1, T2>& ob)
{
    Class5<T1>& c5 = ob;
    Class6<T2>& c6 = ob;
...
template <class T1, class T2> bool operator==(const Class7<T1, T2>& a, const Class7<T1, T2>& b)
{
