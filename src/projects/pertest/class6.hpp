...
template <class T> Class6<T>::Class6(PerIstream& istr)
{
    istr >> *this;
}
...
template <class T> ostream& operator<<(ostream& ostr, const Class6<T>& t)
{
...
template <class T> void perWrite(PerOstream& str, const Class6<T>& ob)
{
    str << ob.i6_;
    str << ob.d6_;
}

template <class T> void perRead(PerIstream& str, Class6<T>& ob)
{
    str >> ob.i6_;
    str >> ob.d6_;
}

template <class T> bool operator==(const Class6<T>& a, const Class6<T>& b)
{
    bool result = true;
