...
//  static
template <class VECTOR, class ITERATOR> void TestVector<VECTOR, ITERATOR>::testVectorOperatorSquareBrackets()
{
...
//  static
template <class VECTOR, class ITERATOR> void TestVector<VECTOR, ITERATOR>::testVectorIteratorOperatorAddition(void)
{
...
//  static
template <class VECTOR, class ITERATOR> void TestVector<VECTOR, ITERATOR>::testVectorIteratorOperatorAddEquals(void)
{
    size_t index = TestVectorAssert::randomIndex1();
    size_t n = TestVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestVector<VECTOR, ITERATOR>::testVectorIteratorOperatorSubtraction(void)
{
...
//  static
template <class VECTOR, class ITERATOR> void TestVector<VECTOR, ITERATOR>::testVectorIteratorDereference(void)
{
    size_t index = TestVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestVector<VECTOR, ITERATOR>::testVectorIteratorComparison(void)
{
    Destinations dA;
    Destinations dB;
    ...
    if (dA == VECTOR1 && indexA <= TestVectorAssert::vector1Size() && dB == VECTOR1
        && indexB <= TestVectorAssert::vector1Size())
        TestVectorAssert::instance().expectedResult(SoakTestAssert::SUCCEED);

    if (dA == VECTOR2 && indexA <= TestVectorAssert::vector2Size() && dB == VECTOR2
        && indexB <= TestVectorAssert::vector2Size())
        TestVectorAssert::instance().expectedResult(SoakTestAssert::SUCCEED);
...
template <class VECTOR, class ITERATOR> TestVector<VECTOR, ITERATOR>::~TestVector()
{
    TEST_INVARIANT;
}

// static
template <class VECTOR, class ITERATOR> void TestVector<VECTOR, ITERATOR>::iteratorInvalidation(void)
{
    size_t index;
    TestIterator i;
...
template <class VECTOR, class ITERATOR> void TestVector<VECTOR, ITERATOR>::CLASS_INVARIANT
{
}

template <class VECTOR, class ITERATOR> ostream& operator<<(ostream& o, const TestVector<VECTOR, ITERATOR>& t)
{
