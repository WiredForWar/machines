...
void TestMinMemoryVector<VECTOR, ITERATOR>::TestMinMemoryVectorIteratorComparison(void)
{
    ...
    if (dA == VECTOR1 && indexA <= TestMinMemoryVectorAssert::vector1Size() && dB == VECTOR1
        && indexB <= TestMinMemoryVectorAssert::vector1Size())
        TestMinMemoryVectorAssert::instance().expectedResult(SoakTestAssert::SUCCEED);

    if (dA == VECTOR2 && indexA <= TestMinMemoryVectorAssert::vector2Size() && dB == VECTOR2
        && indexB <= TestMinMemoryVectorAssert::vector2Size())
        TestMinMemoryVectorAssert::instance().expectedResult(SoakTestAssert::SUCCEED);
...
template <class VECTOR, class ITERATOR> TestMinMemoryVector<VECTOR, ITERATOR>::~TestMinMemoryVector()
{
    TEST_INVARIANT;
}

// static
template <class VECTOR, class ITERATOR> void TestMinMemoryVector<VECTOR, ITERATOR>::iteratorInvalidation(void)
{
    size_t index;
    TestIterator i;
...
template <class VECTOR, class ITERATOR> void TestMinMemoryVector<VECTOR, ITERATOR>::CLASS_INVARIANT
{
}

template <class VECTOR, class ITERATOR> ostream& operator<<(ostream& o, const TestMinMemoryVector<VECTOR, ITERATOR>& t)
{
