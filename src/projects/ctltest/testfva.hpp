...
public:
    ...
    static void
    getValidRandomIterator(TestFixedVectorType& vector, size_t* pIndex, TestFixedVectorType::const_iterator* pI);
    static void
    getValidRandomIteratorInclusive(TestFixedVectorType& vector, size_t* pIndex, TestFixedVectorType::iterator* pI);
