...
void TestVectorAssert::getValidRandomIterator(
    TestVectorType& vector,
    size_t* pIndex,
    TestVectorType::const_iterator* pI)
{
    PRE(vector.size() != 0);
...
//  static
void TestVectorAssert::getValidRandomIteratorInclusive(
    TestVectorType& vector,
    size_t* pIndex,
    TestVectorType::iterator* pI)
{
...
//  static
void TestVectorAssert::getRangeIncluding(
