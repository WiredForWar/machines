...
template <class KEY, class VALUE, class KEY_VALUE_ASSOCIATION> class FtlCollection : public FtlContainer<KEY>
{
public:
    using Value = VALUE;
    using KeyValueAssoc = KEY_VALUE_ASSOCIATION;

    FtlCollection() {};

    ~FtlCollection() override {};
...
template <class VALUE> class FtlValueCollection : public FtlCollection<VALUE, VALUE, VALUE>
{
public:
    FtlValueCollection() {};
...
template <class KEY, class VALUE> class FtlAssociativeCollection : public FtlCollection<KEY, VALUE, FtlPair<KEY, VALUE>>
{
public:
    FtlAssociativeCollection() {};

    ~FtlAssociativeCollection() override {};
