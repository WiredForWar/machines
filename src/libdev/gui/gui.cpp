...
std::string Gui::join(Iterator beginIt, Iterator endIt, std::string_view sep)
{
    std::string result;
    if (beginIt != endIt)
    {
...
template std::string Gui::join<>(StrIt, StrIt, std::string_view);
template std::string Gui::join<>(StrConstIt, StrConstIt, std::string_view);
