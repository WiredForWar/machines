...
std::ostream& operator<<(std::ostream& o, const GuiVerticalScrollBar& t)
{
    ...
    o << "GuiVerticalScrollBar " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "GuiVerticalScrollBar " << static_cast<const void*>(&t) << " end" << std::endl;
...
void GuiVerticalScrollBar::doDisplayBox(const Gui::Box& absoluteBox)
{
    ...
    GuiPainter::instance().line(
        ...
        1);
    GuiPainter::instance().line(
        Gui::Coord(absoluteBox.minCorner().x(), absoluteBox.maxCorner().y() - 1),
        Gui::Coord(absoluteBox.maxCorner().x(), absoluteBox.maxCorner().y() - 1),
        Gui::BLACK(),
        1);
    GuiPainter::instance().line(
        absoluteBox.minCorner(),
    ...
    GuiPainter::instance().line(
        Gui::Coord(absoluteBox.minCorner().x() + 2, absoluteBox.minCorner().y() + halfBoxHeight),
        Gui::Coord(absoluteBox.maxCorner().x() - 2, absoluteBox.minCorner().y() + halfBoxHeight),
        Gui::DARKGREY(),
        1);
    GuiPainter::instance().line(
        Gui::Coord(absoluteBox.minCorner().x() + 2, absoluteBox.minCorner().y() + halfBoxHeight - 2),
