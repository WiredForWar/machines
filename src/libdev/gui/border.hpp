...
{
public:
    GuiBorderMetrics(unsigned frameThickness, unsigned highlightThickness, unsigned shadowThickness);
...
{
public:
    static GuiBorderDimensions exteriorBorder(const Gui::WidthAndHeight& interior, const GuiBorderMetrics&);

    static GuiBorderDimensions interiorBorder(const Gui::WidthAndHeight& exterior, const GuiBorderMetrics& m);
...
public:
    ...
    void display(const Gui::Coord& absCoord, const GuiBorderDimensions&, const GuiBorderMetrics&);
