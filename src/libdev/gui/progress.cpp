...
GuiProgressBar::Percentage GuiProgressBar::percentageComplete()
{
...
// static
unsigned GuiProgressBar::progressWidthInPixels(Percentage progress, unsigned progressCompleteWidth)
