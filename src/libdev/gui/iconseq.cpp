...
unsigned GuiIconSequence::offset() const
{
    return 0;
}
...
// static
GuiIconSequence::Coords GuiIconSequence::translateCoords(const Coords& c, const Gui::Coord& rel)
...
GuiIconSequence::fitCoordsToBox(unsigned boxWidth, unsigned boxHeight, unsigned iconWidth, unsigned iconHeight)
{
...
// static
GuiIconSequence::Coords
GuiIconSequence::arrayCoords(unsigned iconWidth, unsigned iconHeight, unsigned nRows, unsigned nColumns)
{
    Coords result;
...
// static
Gui::Box GuiIconSequence::arrayDimensions(unsigned iconWidth, unsigned iconHeight, unsigned nRows, unsigned nCols)
{
