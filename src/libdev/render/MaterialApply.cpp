...
#include "render/internal/MaterialApply.hpp"
...
void RenIUnlitMatApp::applyViaIndices(const ctl_min_memory_vector<Ren::VertexIdx>& indices, RenILightingBuffer* liteBuf)
    const
{
...
void RenIUnlitMatApp::applyDirectToVertices(RenILightingBuffer* liteBuf, size_t nVertices) const
{
    RenIVertex* vertices = liteBuf->vertices();
    bool* pApplied = liteBuf->matAppliedFlags();
    bool* pPerVertex = liteBuf->perVertexMatFlags();
...
void RenILitMatApp::applyViaIndices(
