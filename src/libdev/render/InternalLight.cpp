...
#ifndef _INLINE
#include "render/internal/InternalLight.ipp"
#endif
...
{
    static const RenLightColourTransform* c = nullptr;
    return c;
}
...
inline void
accumulateIllumination(float* pR, float* pG, float* pB, RenILight::OutputAction sum, const RenColour& colour)
{
    switch (sum)
    {
        case RenILight::INITIALISE:
