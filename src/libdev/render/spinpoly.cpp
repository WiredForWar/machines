...
void RenSpinTFPolygon::applyUVTransform(const RenUVTransform* anim, const RenMaterial& mat) const
{
    TEST_INVARIANT;
...
void RenSpinTFPolygon::render(const MexTransform3d& localToGlobal, const RenScale& scale, const RenUVTransform* anim)
    const
{
    render(localToGlobal, material_, scale, anim);
}

// void RenSpinTFPolygon::updateXForm( const MexTransform3d& globalTransform, const MexTransform3d& cameraTransform,
...
void RenSpinTFPolygon::render(
    ...
    const RenScale& scale,
    const RenUVTransform* anim) const
{
...
void RenSpinTFPolygon::copyVertices(const Vertices& pts)
{
