...
#ifndef _INLINE
#include "render/internal/MaterialBody.ipp"
#endif
...
bool RenIMatBody::operator==(const RenIMatBody& rhs) const
{
    ...
    return diffuse_ == rhs.diffuse_ && texture_ == rhs.texture_ && depth_ == rhs.depth_
...
void perWrite(PerOstream& ostr, const RenIMatBody& mat)
{
    ...
    // persisted either.
    const uchar packedBools = pack6Bools(
        mat.interMeshCoplanar_,
        mat.sharable_,
