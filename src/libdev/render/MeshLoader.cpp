...
static RenID3DMeshLoader::FileMap::const_iterator
linearFind(const RenID3DMeshLoader::FileMap& map, const std::string& key)
{
...
RenID3DMeshLoader::MeshData RenID3DMeshLoader::load(const SysPathName& pathName, const std::string& meshName)
{
    PRE(pHierarchyBuilder_ == nullptr);
...
void RenID3DMeshLoader::load(const SysPathName& pathName, RenHierarchyBuilder* pBuilder)
{
    ...
    POST(pHierarchyBuilder_ == nullptr);
}
