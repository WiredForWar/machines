...
void RenIDepthPostSorter::addItem(std::unique_ptr<RenIDepthSortedItem>& item)
{
...
#ifndef NDEBUG
static void
checkTransitivity(const RenIDepthSortedItem* i1, const RenIDepthSortedItem* i2, const RenIDepthSortedItem* i3)
{
    PRE(i1);
    PRE(i2);
    PRE(i3);
