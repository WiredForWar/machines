...
#include "render/internal/DriverDeprecated.hpp"
...
// virtual
const RenIDriverInfo* RenIDriverSelector::chooseForFullScreen(RenDisplay& display, bool ignoreHw) const
{
...
const RenIDriverInfo* RenIDriverSelector::chooseForDepth(int bitDepth, bool ignoreHw) const
{
    const RenIDriverInfo* choice = nullptr;
