...
#ifndef _INLINE
#include "render/internal/TriangleGroup.ipp"
#endif
...
inline void pushBackIndex(ctl_min_memory_vector<Ren::VertexIdx>* vec, Ren::VertexIdx idx, Ren::VertexIdx* max)
{
    vec->push_back(idx);
...
void RenIDistinctGroup::triangle(Ren::TriangleIdx tri, Ren::VertexIdx* v1, Ren::VertexIdx* v2, Ren::VertexIdx* v3) const
{
    PRE(v1 && v2 && v3);
    PRE(tri < nTriangles());
    const int idx = tri * 3;
