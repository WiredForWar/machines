...
{
public:
    void apply(glm::mat4*) const override;
    void apply(MexPoint3d*) const override;
    void project(const MexVec2& yz, MATHEX_SCALAR* inPlane, MATHEX_SCALAR* x) const override;
    ...
    MATHEX_SCALAR average() const override;
