...
private:
    ...
    using GXMeshes = ctl_vector<GXMesh*>;
    using GXMeshesMap = ctl_map<std::string, GXMeshes*, std::less<std::string>>;
    using GXHierMap = ctl_map<std::string, GXHier*, std::less<std::string>>;
