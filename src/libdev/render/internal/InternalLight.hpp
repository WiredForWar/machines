...
#include "render/internal/FixedPoint.hpp"
...
public:
    ...
    void lightVerticesMMX(
        const RenIVertexData&,
...
protected:
    ...
    float
    attenuation(MATHEX_SCALAR x, MATHEX_SCALAR y, MATHEX_SCALAR z, const MexPoint3d& pos, MATHEX_SCALAR sqrRange) const;
...
private:
    bool
    boundingVolumeUniformlyLit(const MexAlignedBox3d* pVolume, const MexPoint3d& pos, MATHEX_SCALAR, float* pResult)
        const;
};
...
#ifdef _INLINE
#include "internal/InternalLight.ipp"
#endif
