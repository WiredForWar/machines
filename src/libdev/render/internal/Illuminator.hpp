...
public:
    ...
    void lightVertices(const RenIVertexData& in, const MexAlignedBox3d* pVolume = nullptr);
    ...
    void lightVertices(const RenIVertexData& in, size_t nVertices, const MexAlignedBox3d* pVolume = nullptr);

    using Indices = ctl_min_memory_vector<Ren::VertexIdx>;
    ...
    RenI::LitVtxAPtr
    applyMaterialAndCopy(const RenMaterial&, const RenIVertexData& in, const Indices&, Ren::VertexIdx nIndicesUsed);
...
#ifdef _INLINE
#include "internal/Illuminator.ipp"
#endif
