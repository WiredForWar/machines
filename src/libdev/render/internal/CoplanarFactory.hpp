...
template <class ID, class PART> class UtlCPFactory
{
public:
    UtlCPFactory();
...
protected:
    using PartPair = std::pair<const ID, PART>;
    using PartMap = ctl_map<ID, PART, std::less<ID>>;
...
#include "render/internal/CoplanarFactory.ctp"
// #endif
