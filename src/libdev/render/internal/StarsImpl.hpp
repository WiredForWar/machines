...
{
public:
    RenIStarsImpl(RenStars::Configuration, MATHEX_SCALAR radius, uint nStars);
...
private:
    ...
    void
    renderNorthCap(MexRadians verticalFOV, ctl_vector<RenIVertex*>* const pVertexPtrs, ctl_vector<int>* const pSizes);

    void
    renderSouthCap(MexRadians verticalFOV, ctl_vector<RenIVertex*>* const pVertexPtrs, ctl_vector<int>* const pSizes);
...
#ifdef _INLINE
#include "internal/StarsImpl.ipp"
#endif
