...
class RenderBackendGL33 final : public IRenderBackend
{
public:
    RenderBackendGL33();
...
private:
    ...
    // GL 3.3 core requires a VAO to be bound for all vertex operations.
    GLuint defaultVAO_{};
    ...
    public:
        ...
        // GL 3.3 core has no glAlphaFunc — we track the state and pass it
        // as a uniform so the fragment shader can do `discard`.
