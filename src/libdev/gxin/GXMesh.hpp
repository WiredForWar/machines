...
#include "gxin/Point3.hpp"
#include "gxin/Vec3.hpp"
#include "gxin/Polygon3.hpp"
#include "gxin/Textures.hpp"
...
public:
    ...
    // been implemented
    GXPoint3& point(int i) { return points_[i]; }
    const GXPoint3& point(int i) const { return points_[i]; }
