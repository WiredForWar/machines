...
bool operator<(const GXMat& mat1, const GXMat& mat2)
{
    ...
    else if ((mat1.diffuseColor_ == mat2.diffuseColor_) && (mat1.transparancy_ < mat2.transparancy_))
    {
        result = true;
    }
    else if (
        (mat1.diffuseColor_ == mat2.diffuseColor_) && (mat1.transparancy_ == mat2.transparancy_)
...
bool operator==(const GXMat& mat1, const GXMat& mat2)
{
    ...
    if ((mat1.hasOneColor_ == mat2.hasOneColor_) && (mat1.diffuseColor_ == mat2.diffuseColor_)
        && (mat1.transparancy_ == mat2.transparancy_) && (mat1.textureId_ == mat2.textureId_))
        result = true;
