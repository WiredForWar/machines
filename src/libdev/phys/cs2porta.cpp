...
PhysCS2dPortal::PhysCS2dPortal(
    const PhysConfigSpace2d::DomainId& domainId1,
    ...
    ObstacleFlags flags)
{
    ...
    const MATHEX_SCALAR y = endPoint1_.y() * (1 - proportionalDistance) + endPoint2_.y() * proportionalDistance;
    ...
    if (addVertex)
    {
        ...
        pDomainGraph->addVertex(domainVertexId, PhysCS2dDomainVertex(position, clearance, flags, portalId));
...
void PhysCS2dPortal::removeDomainVertex(
    PhysConfigSpace2d::DomainVertexId domainVertexId,
    PhysCS2dDomainGraph* pDomainGraph)
{
...
MexPoint2d PhysCS2dPortal::proportionalPoint(MATHEX_SCALAR f) const
{
    ...
    return MexPoint2d(endPoint1_.x() * g + endPoint2_.x() * f, endPoint1_.y() * g + endPoint2_.y() * f);
}
//////////////////////////////////////////////////////////////////////////////////////////
/* End CS2PORTA.CPP *************************************************/
