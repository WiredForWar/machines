...
void PhysAccelerateTumblePlan::setPosition(const PhysRelativeTime& timeFromStartOfSegment, MexTransform3d* pResult)
    const
{
    CB_DEPIMPL(size_t, currentSegmentIndex_);
...
void PhysAccelerateTumblePlan::setRotation(const PhysRelativeTime& timeFromStartOfSegment, MexTransform3d* pResult)
    const
{
