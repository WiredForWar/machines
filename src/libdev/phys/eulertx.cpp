...
PhysEulerTransform3d::PhysEulerTransform3d(const MexEulerAngles& angles)
    : angles_(angles)
    , position_(0.0, 0.0, 0.0)
{
}

PhysEulerTransform3d::PhysEulerTransform3d(const MexEulerAngles& angles, const MexPoint3d& position)
    : angles_(angles)
    , position_(position)
{
}
