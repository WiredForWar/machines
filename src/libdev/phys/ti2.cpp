...
void PhysDummyFunction2()
{
    ...
    static PhysConfigSpace2d dummy11(MexPoint2d(0, 0), MexPoint2d(1, 1), PhysConfigSpace2d::SUBTRACTIVE, 100, 1, 10, 0);
    static PhysCS2dExpansionSpace* pExpansionSpace = nullptr;
