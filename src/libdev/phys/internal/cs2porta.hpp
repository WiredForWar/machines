...
public:
    ...
    void removeDomainVertex(PhysConfigSpace2d::DomainVertexId domainVertexId, PhysCS2dDomainGraph* pDomainGraph);
    ...
    friend std::ostream& operator<<(std::ostream& o, const PhysCS2dPortal& t);
...
private:
    ...
    using DomainVertexIds = ctl_vector<PhysConfigSpace2d::DomainVertexId>;
