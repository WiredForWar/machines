...
void PhysCS2dDomain::removePortal(const PhysConfigSpace2d::PortalId& id)
{
    ...
    ctl_vector<PhysConfigSpace2d::PortalId>::iterator i = find(portals_.begin(), portals_.end(), id);
    POST(i != portals_.end());
...
//////////////////////////////////////////////////////////////////////////////////////////
_CODE_INLINE
size_t PhysCS2dDomain::nPortals() const
{
    return portals_.size();
}
//////////////////////////////////////////////////////////////////////////////////////////
_CODE_INLINE
const ctl_vector<PhysConfigSpace2d::PortalId>& PhysCS2dDomain::portals() const
{
    return portals_;
}
//////////////////////////////////////////////////////////////////////////////////////////
_CODE_INLINE
const PhysConfigSpace2d::DomainId& PhysCS2dDomain::id() const
{
    return id_;
}
//////////////////////////////////////////////////////////////////////////////////////////
