...
public:
    ...
    PolygonId addPolygon(const MexPolygon2d& oldPolygon, const PolygonId& oldId, ObstacleFlags flags);
    ...
    friend std::ostream& operator<<(std::ostream& o, const PhysCS2dExpansionSpace& t);
...
private:
    ...
    using PolygonIdMap = FtlSerialMap<PolygonId>;
