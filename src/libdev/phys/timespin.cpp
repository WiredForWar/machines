...
void PhysTimedSpinPlan::addSegment(const PhysRelativeTime& segmentDuration, const MexRadians& acceleration)
{
    ...
    MexRadians endAngle = MexRadians(PhysRampAcceleration::distance(
        startAngle.asScalar(),
        startSpeed.asScalar(),
    ...
    MexRadians endSpeed
        = MexRadians(PhysRampAcceleration::endSpeed(startSpeed.asScalar(), acceleration.asScalar(), segmentDuration));
...
MexRadians PhysTimedSpinPlan::angle(const PhysRelativeTime& timeOffset) const
{
    ...
    else
    {
        ...
        timeAngle = MexRadians(PhysRampAcceleration::distance(
            startAngle.asScalar(),
            startSpeed.asScalar(),
...
MexRadians PhysTimedSpinPlan::speed(const PhysRelativeTime& timeOffset) const
{
    ...
    else
    {
        ...
        timeSpeed = MexRadians(PhysRampAcceleration::endSpeed(
            startSpeed.asScalar(),
            accelerations_[cacheIndex_].asScalar(),
            timeOffset - startTime));
    }
