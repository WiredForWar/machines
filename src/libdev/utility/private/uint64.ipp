...
inline UtlUint64::UtlUint64(uint32 copyMe)
{
    data_[LS] = copyMe;
    data_[MS] = 0;
}
...
inline UtlUint64& UtlUint64::operator=(uint32 rhs)
{
    data_[LS] = rhs;
    data_[MS] = 0;
...
inline UtlUint64& UtlUint64::operator+=(const UtlUint64& rhs)
{
...
inline uint32* UtlUint64::data()
{
    return data_;
}

inline double UtlUint64::asDouble() const
{
    double dValue;
