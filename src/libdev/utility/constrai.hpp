...
template <class T> class UtlTypeBase
...
template <class PREDICATE> class UtlConstrainedType : private UtlTypeBase<typename PREDICATE::argument_type>
// memberwise cannonical according as PREDICATE::argument_type
{
public:
    using T = typename PREDICATE::argument_type;
    ...
    bool isValid(const T& t) const { return PREDICATE(t); }
...
template <class T> class UtlSubclassableConstrainedType : private UtlTypeBase<T>
// memberwise cannonical according as T
{
public:
    using ConstrainedTypeBase = UtlSubclassableConstrainedType;
    ...
    bool isValid(const T& t) const { return fn_(t); }

protected:
    using b_fn_T = bool (*)(const T&);
