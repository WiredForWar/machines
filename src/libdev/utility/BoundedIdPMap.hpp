...
#include "utility/private/BoundedIdPMapVoid.hpp"

// orthodox canonical (revoked)
template <class X> class UtlBoundedIdPMap : public UtlBoundedIdVoidPMap
{
public:
    ...
    friend std::ostream& operator<<(std::ostream& o, const UtlBoundedIdPMap<X>& t);
...
#include "utility/BoundedIdPMap.ctp"
// #endif

#ifdef _INLINE
#include "utility/BoundedIdPMap.itp"
#endif
