...
template <class NUMERIC> class UtlOpenInterval
...
private:
    void CLASS_INVARIANT { INVARIANT(isOpenInterval(lower(), upper())); }
...
template <class NUMERIC> bool operator<(const UtlOpenInterval<NUMERIC>& a, const UtlOpenInterval<NUMERIC>& b)
{
    return a.isBefore(b);
}
...
// static
template <class NUMERIC> bool UtlOpenInterval<NUMERIC>::isOpenInterval(NUMERIC lower, NUMERIC upper)
{
    return lower <= upper;
}
...
template <class NUMERIC> bool UtlOpenInterval<NUMERIC>::isBefore(const UtlOpenInterval& other) const
{
...
template <class NUMERIC> bool UtlOpenInterval<NUMERIC>::isAfter(const UtlOpenInterval& other) const
{
...
template <class NUMERIC> bool UtlOpenInterval<NUMERIC>::meets(const UtlOpenInterval& other) const
{
    return upper() == other.lower();
}

template <class NUMERIC> bool UtlOpenInterval<NUMERIC>::overlaps(const UtlOpenInterval& other) const
{
    return contains(other.lower()) or contains(other.upper());
}

template <class NUMERIC> bool UtlOpenInterval<NUMERIC>::contains(const UtlOpenInterval& other) const
{
    return contains(other.lower()) and contains(other.upper());
}

template <class NUMERIC> NUMERIC UtlOpenInterval<NUMERIC>::lower() const
{
    return lower_;
}

template <class NUMERIC> void UtlOpenInterval<NUMERIC>::lower(NUMERIC newlower)
{
    PRE(isOpenInterval(newlower, upper()));
    lower_ = newlower;
    POST(lower() == newlower);
...
template <class NUMERIC> NUMERIC UtlOpenInterval<NUMERIC>::upper() const
{
    return upper_;
}

template <class NUMERIC> void UtlOpenInterval<NUMERIC>::upper(NUMERIC newupper)
{
    PRE(isOpenInterval(lower(), newupper));
    upper_ = newupper;
    POST(upper() == newupper);
...
template <class NUMERIC> NUMERIC UtlOpenInterval<NUMERIC>::length() const
{
    return upper() - lower();
}
