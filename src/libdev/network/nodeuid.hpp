...
{
public:
    NetNodeUid(const NetProcessorUid& pUid, NetThreadUid tUid, NetInterProcessUid iUid, const NetNodeName& nodeName);
...
private:
    ...
    NetNodeUid(const NetProcessUid& pUid, NetInterProcessUid iUid, const NetNodeName& nodeName);
