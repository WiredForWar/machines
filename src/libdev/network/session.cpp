...
std::ostream& operator<<(std::ostream& o, NetAppSession::NetSessionStatus status)
{
    switch (status)
    {
        case NetAppSession::NETSESS_OK:
            o << "NETSESS_OK";
            break;
        case NetAppSession::NETSESS_INVALIDDATA:
            o << "NETSESS_INVALIDDATA";
            break;
        case NetAppSession::NETSESS_NOSESSIONS:
            o << "NETSESS_NOSESSIONS";
            break;
        case NetAppSession::NETSESS_INVALIDSUPPLIEDDATA:
            o << "NETSESS_INVALIDSUPPLIEDDATA";
            break;
        case NetAppSession::NETSESS_NETWORKERROR:
            o << "NETSESS_NETWORKERROR";
            break;
        case NetAppSession::NETSESS_ALREADYCONNECTING:
            o << "NETSESS_ALREADYCONNECTING";
            break;
        case NetAppSession::NETSESS_INTERNALDATAERROR:
            o << "NETSESS_INTERNALDATAERROR";
            break;
        case NetAppSession::NETSESS_UNABLETOCONNECT:
            o << "NETSESS_UNABLETOCONNECT";
            break;
        case NetAppSession::NETSESS_UNDEFINEDERROR:
            o << "NETSESS_UNDEFINEDERROR";
            break;
        case NetAppSession::NETSESS_INVALIDPLAYER:
            o << "NETSESS_INVALIDPLAYER";
            break;
        default:
            o << "Unknown status in NetAppSession " << (int)status << std::endl;
    }
    return o;
}
