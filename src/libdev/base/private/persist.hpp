...
public:
    ...
    void writePointerPost(PerOstream&, const void* pOb, const char* className, const void* pMostDerivedOb);
...
enum PerConstructor
{
    PERSISTENCE_CONSTRUCTOR
};

//================= DEBUG MACROS ===================================================

#define PER_PRIVATE_WRITE_INDENT_STREAM(exp)                                                                           \
    DiagInternal::streamEnabled(DIAG_PER_WRITE) ? Persistence::instance().debugWriteStream() << exp                    \
                                                : Persistence::instance().debugWriteStream() << ""
#define PER_PRIVATE_READ_INDENT_STREAM(exp)                                                                            \
    DiagInternal::streamEnabled(DIAG_PER_READ) ? Persistence::instance().debugReadStream() << exp                      \
                                               : Persistence::instance().debugReadStream() << ""
...
#define PER_PRIVATE_MEMBER_PERSISTENT_STANDARD_INLINE(className, VIRTUAL)                                              \
                                                                                                                       \
public:                                                                                                                \
    static const char* perClassName() PER_PRIVATE_CLASSNAME_DEFINITION(className) private                              \
        : VIRTUAL const char*                                                                                          \
          perMostDerivedClassName() const PER_PRIVATE_VIRTUAL_CLASSNAME_DEFINITION VIRTUAL char*                       \
          perPDerivedClass() const PER_PRIVATE_P_DERIVED_CLASS_DEFINITION friend PerOstream&                           \
          operator<<(PerOstream& ostr, const className& ob) PER_OBJECT_WRITE(className) friend PerIstream&             \
          operator>>(PerIstream& istr, className& ob) PER_OBJECT_READ(className) friend PerOstream&                    \
          operator<<(PerOstream& ostr, const className* pOb) PER_POINTER_WRITE(className) friend PerIstream&           \
          operator>>(PerIstream& istr, className*& pOb) PER_POINTER_READ(className, className::perCreate()) public:
...
#define PER_PRIVATE_FRIEND_ENUM_PERSISTENT(TYPE)                                                                       \
    friend PER_PRIVATE_WRITE_ENUM_DEFINITION(TYPE) friend PER_PRIVATE_READ_ENUM_DEFINITION(TYPE)
...
#define PER_PRIVATE_DEFINE_PERSISTENT(className)                                                                       \
    ...
    PerOstream& operator<<(PerOstream& ostr, const className& ob) PER_OBJECT_WRITE(className) PerIstream& operator>>(  \
        PerIstream& istr,                                                                                              \
        className& ob) PER_OBJECT_READ(className) PerOstream&                                                          \
    operator<<(PerOstream& ostr, const className* pOb) PER_POINTER_WRITE(className) PerIstream&                        \
...
#define PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT(className)                                                              \
    ...
    PerOstream& operator<<(PerOstream& ostr, const className& ob) PER_OBJECT_WRITE(className) PerIstream& operator>>(  \
        ...
        className& ob) PER_OBJECT_READ(className) PerOstream&                                                          \
    operator<<(PerOstream& ostr, const className* pOb) PER_POINTER_WRITE(className) PerIstream&                        \
    operator>>(PerIstream& istr, className*& pOb) PER_POINTER_READ_ABSTRACT(className)

#define PER_PRIVATE_DEFINE_PERSISTENT_INLINE(className)                                                                \
    friend PerOstream& operator<<(PerOstream& ostr, const className& ob)                                               \
        PER_OBJECT_WRITE(className) friend PerIstream&                                                                 \
        operator>>(PerIstream& istr, className& ob) PER_OBJECT_READ(className) friend PerOstream&                      \
        operator<<(PerOstream& ostr, const className* pOb) PER_POINTER_WRITE(className) friend PerIstream&             \
        operator>>(PerIstream& istr, className*& pOb) PER_POINTER_READ(className)
...
#define CLASS_LIST_T6                                                                                                  \
    class T1 PER_COMMA class T2 PER_COMMA class T3 PER_COMMA class T4 PER_COMMA class T5 PER_COMMA class T6
#define CLASS_LIST_T7                                                                                                  \
    class T1 PER_COMMA class T2 PER_COMMA class T3 PER_COMMA class T4 PER_COMMA class T5 PER_COMMA class T6            \
        PER_COMMA class T7
#define CLASS_LIST_T8                                                                                                  \
    class T1 PER_COMMA class T2 PER_COMMA class T3 PER_COMMA class T4 PER_COMMA class T5 PER_COMMA class T6            \
        PER_COMMA class T7 PER_COMMA class T8
#define CLASS_LIST_T9                                                                                                  \
    class T1 PER_COMMA class T2 PER_COMMA class T3 PER_COMMA class T4 PER_COMMA class T5 PER_COMMA class T6            \
        PER_COMMA class T7 PER_COMMA class T8 PER_COMMA class T9
#define CLASS_LIST_T10                                                                                                 \
    class T1 PER_COMMA class T2 PER_COMMA class T3 PER_COMMA class T4 PER_COMMA class T5 PER_COMMA class T6            \
        PER_COMMA class T7 PER_COMMA class T8 PER_COMMA class T9 PER_COMMA class T10
...
#define LIST_T9                                                                                                        \
    T1 PER_COMMA T2 PER_COMMA T3 PER_COMMA T4 PER_COMMA T5 PER_COMMA T6 PER_COMMA T7 PER_COMMA T8 PER_COMMA T9
#define LIST_T10                                                                                                       \
    T1 PER_COMMA T2 PER_COMMA T3 PER_COMMA T4 PER_COMMA T5 PER_COMMA T6 PER_COMMA T7 PER_COMMA T8 PER_COMMA T9         \
        PER_COMMA T10

#define PER_PRIVATE_DECLARE_PERSISTENT_T(className, CLASS_LIST_T, LIST_T)                                              \
    template <CLASS_LIST_T> PerOstream& operator<<(PerOstream& ostr, const className<LIST_T>& ob);                     \
    template <CLASS_LIST_T> PerIstream& operator>>(PerIstream& istr, className<LIST_T>& ob);                           \
    template <CLASS_LIST_T> PerOstream& operator<<(PerOstream& ostr, const className<LIST_T>* pOb);                    \
    template <CLASS_LIST_T> PerIstream& operator>>(PerIstream& istr, className<LIST_T>*& pOb);
...
#define PER_PRIVATE_DEFINE_PERSISTENT_T(className, LIST_T, STRING_T)                                                   \
    ...
    template <>                                                                                                        \
    PerOstream& operator<< <LIST_T>(PerOstream& ostr, const className<LIST_T>& ob)                                     \
        PER_OBJECT_WRITE(className) template <>                                                                        \
        PerIstream& operator>><LIST_T>(PerIstream& istr, className<LIST_T>& ob) PER_OBJECT_READ(className) template <> \
        PerOstream& operator<< <LIST_T>(PerOstream& ostr, const className<LIST_T>* pOb)                                \
            PER_POINTER_WRITE(className##STRING_T) template <>                                                         \
            PerIstream& operator>><LIST_T>(PerIstream& istr, className<LIST_T>*& pOb) PER_POINTER_READ(                \
                className##STRING_T,                                                                                   \
                (className<LIST_T>::perCreate())) void perRead##className##STRING_T(PerIstream& istr)                  \
    {                                                                                                                  \
...
#define PER_PRIVATE_DEFINE_PERSISTENT_INLINE_T(className, CLASS_LIST_T, LIST_T)                                        \
    ...
    PerOstream& operator<<(PerOstream& ostr, const className<LIST_T>& ob)                                              \
        PER_OBJECT_WRITE(className) template <CLASS_LIST_T>                                                            \
        PerIstream& operator>>(PerIstream& istr, className<LIST_T>& ob)                                                \
            PER_OBJECT_READ(className) template <CLASS_LIST_T>                                                         \
    ...
    template <CLASS_LIST_T> inline const char* className<LIST_T>::perClassName()                                       \
    {                                                                                                                  \
        return #className;                                                                                             \
    }

#define PER_PRIVATE_READ_WRITE_T(className, CLASS_LIST_T, LIST_T)                                                      \
    template <CLASS_LIST_T> void perWrite(PerOstream&, const className<LIST_T>&);                                      \
    template <CLASS_LIST_T> void perRead(PerIstream&, className<LIST_T>&);

#define PER_PRIVATE_REGISTER_DERIVED_CLASS_T(className, LIST_T, STRING_T)                                              \
    Persistence::instance().registerDerivedClass(                                                                      \
        className<LIST_T>::perClassName(),                                                                             \
        perWrite##className##STRING_T,                                                                                 \
        perRead##className##STRING_T)
...
#define PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T1(className, T1)                                                       \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T(className, T1, #T1)
// #define PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T1( className ) PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T( className,
// CLASS_LIST_T1, LIST_T1 ) #define PER_PRIVATE_STREAM_CREATE_FUNCTION_T1( className )
// PER_PRIVATE_STREAM_CREATE_FUNCTION_T( className, CLASS_LIST_T1, LIST_T1 )
#define PER_PRIVATE_REGISTER_DERIVED_CLASS_T1(className, T1)                                                           \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T(className, LIST_T1, T1)
#define PER_PRIVATE_READ_WRITE_T1(className) PER_PRIVATE_READ_WRITE_T(className, CLASS_LIST_T1, LIST_T1)

#define PER_PRIVATE_DEFINE_PERSISTENT_INLINE_T1(className)                                                             \
    PER_PRIVATE_DEFINE_PERSISTENT_INLINE_T(className, CLASS_LIST_T1, LIST_T1)

#define PER_PRIVATE_DECLARE_PERSISTENT_T2(className) PER_PRIVATE_DECLARE_PERSISTENT_T(className, CLASS_LIST_T2, LIST_T2)
#define PER_PRIVATE_DEFINE_PERSISTENT_T2(className, T1, T2)                                                            \
    PER_PRIVATE_DEFINE_PERSISTENT_T(className, T1 PER_COMMA T2, T1##T2)
#define PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T2(className, T1, T2)                                                   \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T(className, T1 PER_COMMA T2, #T1## #T2)
#define PER_PRIVATE_READ_WRITE_PERSISTENT_T2(className, T1, T2)                                                        \
    PER_READ_WRITE_PERSISTENT_T(className, T1 PER_COMMA T2, T1##T2)
// #define PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T2( className ) PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T( className,
// CLASS_LIST_T2, LIST_T2 ) #define PER_PRIVATE_STREAM_CREATE_FUNCTION_T2( className )
// PER_PRIVATE_STREAM_CREATE_FUNCTION_T( className, CLASS_LIST_T2, LIST_T2 )
#define PER_PRIVATE_REGISTER_DERIVED_CLASS_T2(className, T1, T2)                                                       \
    PER_PRIVATE_REGISTER_DERIVED_CLASS_T(className, T1 PER_COMMA T2, T1##T2)
...
#define PER_PRIVATE_DEFINE_PERSISTENT_T3(className, T1, T2, T3)                                                        \
    PER_PRIVATE_DEFINE_PERSISTENT_T(className, T1 PER_COMMA T2 PER_COMMA T3, #T1## #T2## #T3)
#define PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T3(className, T1, T2, T3)                                               \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T(className, T1 PER_COMMA T2 PER_COMMA T3, #T1## #T2## #T3)
// #define PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T3( className ) PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T( className,
// CLASS_LIST_T3, LIST_T3 ) #define PER_PRIVATE_STREAM_CREATE_FUNCTION_T3( className )
// PER_PRIVATE_STREAM_CREATE_FUNCTION_T( className, CLASS_LIST_T3, LIST_T3 )
#define PER_PRIVATE_REGISTER_DERIVED_CLASS_T3(className, T1, T2, T3)                                                   \
    Persistence::instance().registerDerivedClass(className<T1, T2, T3>::perClassName(), NULL)

#define PER_PRIVATE_DECLARE_PERSISTENT_T4(className) PER_PRIVATE_DECLARE_PERSISTENT_T(className, CLASS_LIST_T4, LIST_T4)
#define PER_PRIVATE_DEFINE_PERSISTENT_T4(className, T1, T2, T3, T4)                                                    \
    PER_PRIVATE_DEFINE_PERSISTENT_T(className, T1 PER_COMMA T2 PER_COMMA T3 PER_COMMA T4, #T1## #T2## #T3## #T4)
#define PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T4(className, T1, T2, T3, T4)                                           \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T(                                                                          \
        className,                                                                                                     \
        T1 PER_COMMA T2 PER_COMMA T3 PER_COMMA T4,                                                                     \
        #T1## #T2## #T3## #T4)
// #define PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T4( className ) PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T( className,
// CLASS_LIST_T4, LIST_T4 ) #define PER_PRIVATE_STREAM_CREATE_FUNCTION_T4( className )
// PER_PRIVATE_STREAM_CREATE_FUNCTION_T( className, CLASS_LIST_T4, LIST_T4 )
#define PER_PRIVATE_REGISTER_DERIVED_CLASS_T4(className, T1, T2, T3, T4)                                               \
    Persistence::instance().registerDerivedClass(className<T1, T2, T3, T4>::perClassName(), NULL)

#define PER_PRIVATE_DECLARE_PERSISTENT_T5(className) PER_PRIVATE_DECLARE_PERSISTENT_T(className, CLASS_LIST_T5, LIST_T5)
#define PER_PRIVATE_DEFINE_PERSISTENT_T5(className, T1, T2, T3, T4, T5)                                                \
    PER_PRIVATE_DEFINE_PERSISTENT_T(                                                                                   \
        className,                                                                                                     \
        T1 PER_COMMA T2 PER_COMMA T3 PER_COMMA T4 PER_COMMA T5,                                                        \
        #T1## #T2## #T3## #T4## #T5)
#define PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T5(className, T1, T2, T3, T4, T5)                                       \
    PER_PRIVATE_DEFINE_PERSISTENT_ABSTRACT_T(                                                                          \
        className,                                                                                                     \
        T1 PER_COMMA T2 PER_COMMA T3 PER_COMMA T4 PER_COMMA T5,                                                        \
        #T1## #T2## #T3## #T4## #T5)
// #define PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T5( className ) PER_PRIVATE_DEFAULT_CREATE_FUNCTION_T( className,
// CLASS_LIST_T5, LIST_T5 ) #define PER_PRIVATE_STREAM_CREATE_FUNCTION_T5( className )
// PER_PRIVATE_STREAM_CREATE_FUNCTION_T( className, CLASS_LIST_T5, LIST_T5 )
#define PER_PRIVATE_REGISTER_DERIVED_CLASS_T5(className, T1, T2, T3, T4, T5)                                           \
    Persistence::instance().registerDerivedClass(className<T1, T2, T3, T4, T5>::perClassName(), NULL)

// #define  PER_PRIVATE_REGISTER_DERIVED_CLASS_T6( className, T1, T2, T3, T4, T5, T6 )
// Persistence::instance().registerDerivedClass( className< T1, T2, T3, T4, T5, T6 >::perClassName(), &className< T1,
// T2, T3, T4, T5, T6 >::perCreateFromFile ) #define  PER_PRIVATE_REGISTER_DERIVED_CLASS_T7( className, T1, T2, T3, T4,
// T5, T6, T7 ) Persistence::instance().registerDerivedClass( className< T1, T2, T3, T4, T5, T6, T7 >::perClassName(),
// &className< T1, T2, T3, T4, T5, T6, T7 >::perCreateFromFile ) #define  PER_PRIVATE_REGISTER_DERIVED_CLASS_T8(
// className, T1, T2, T3, T4, T5, T6, T7, T8 ) Persistence::instance().registerDerivedClass( className< T1, T2, T3, T4,
// T5, T6, T7, T8 >::perClassName(), &className< T1, T2, T3, T4, T5, T6, T7, T8 >::perCreateFromFile ) #define
// PER_PRIVATE_REGISTER_DERIVED_CLASS_T9( className, T1, T2, T3, T4, T5, T6, T7, T8, T9 )
// Persistence::instance().registerDerivedClass( className< T1, T2, T3, T4, T5, T6, T7, T8, T9 >::perClassName(),
// &className< T1, T2, T3, T4, T5, T6, T7, T8, T9 >::perCreateFromFile ) #define PER_PRIVATE_REGISTER_DERIVED_CLASS_T10(
// className, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 ) Persistence::instance().registerDerivedClass( className< T1, T2,
// T3, T4, T5, T6, T7, T8, T9, T10 >::perClassName(), &className< T1, T2, T3, T4, T5, T6, T7, T8, T9, T10
// >::perCreateFromFile )
...
#define PER_PRIVATE_DEFINE_NON_INTRUSIVE_PERSISTENT_T(className, CLASS_LIST_T, LIST_T)                                 \
    ...
    PerOstream& operator<<(PerOstream& ostr, const className<LIST_T>& ob)                                              \
        PER_OBJECT_WRITE(className) template <CLASS_LIST_T>                                                            \
        PerIstream& operator>>(PerIstream& istr, className<LIST_T>& ob) PER_OBJECT_READ(className)
