...
// public
MachPhysDoublesidedFlame::MachPhysDoublesidedFlame(W4dEntity* pParent, const MexTransform3d& localTransform)
    ...
    const PhysRelativeTime& duration)
{
    ...
    // Play burning sound
    W4dSoundManager::instance().playForDuration(pParent(), SID_BURNING, startTime, duration);
