...
std::ostream& operator<<(std::ostream& o, const MachPhysBolter& t)
{

    o << "MachPhysBolter " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysBolter " << static_cast<const void*>(&t) << " end" << std::endl;
...
void MachPhysBolter::playFiringSounds(const PhysAbsoluteTime& startTime)
{
        ...
        case MachPhys::AUTO_CANNON:
            {
                ...
                W4dSoundManager::instance().play(this, SID_AUTOBK, PhysAbsoluteTime(0), 1);
    ...
    {
        W4dSoundManager::instance().play(this, sndData, PhysAbsoluteTime(0), 1);
