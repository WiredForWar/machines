...
std::ostream& operator<<(std::ostream& o, const MachPhysLoadingOver& t)
{

    o << "MachPhysLoadingOver " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysLoadingOver " << static_cast<const void*>(&t) << " end" << std::endl;
