...
std::ostream& operator<<(std::ostream& o, const MachPhysPlasmaWeapon& t)
{

    o << "MachPhysPlasmaWeapon " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysPlasmaWeapon " << static_cast<const void*>(&t) << " end" << std::endl;
...
// static
PhysRelativeTime
MachPhysPlasmaWeapon::applyVictimAnimation(const PhysAbsoluteTime&, const MexLine3d&, MachPhysConstruction*)
{
    return 0.0;
}
...
// static
PhysRelativeTime
MachPhysPlasmaWeapon::applyVictimAnimation(const PhysAbsoluteTime&, const MexLine3d&, MachPhysArtefact*)
{
    return 0.0;
}
