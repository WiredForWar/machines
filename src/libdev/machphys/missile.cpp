...
std::ostream& operator<<(std::ostream& o, const MachPhysMissile& t)
{

    o << "MachPhysMissile " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysMissile " << static_cast<const void*>(&t) << " end" << std::endl;
