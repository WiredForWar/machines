...
public:
    ...
    using Id = MachPhysSubTypeId<MachPhys::TechnicianSubType>;
...
private:
    ...
    using Factory = MachPhysObjectFactory<Id, MachPhysTechnician>;
    ...
    static SysPathName compositeFileName(MachPhys::TechnicianSubType subType, size_t bodyLevel);
