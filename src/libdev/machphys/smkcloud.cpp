...
MachPhysSmokeCloud::MachPhysSmokeCloud(W4dEntity* pParent, const MexPoint3d& startPosition)
...
PhysRelativeTime MachPhysSmokeCloud::startSmoking(
    ...
    const PhysRelativeTime& wispInterval,
    MATHEX_SCALAR wispSize,
    MATHEX_SCALAR zDepthOffset,
...
// virtual
bool MachPhysSmokeCloud::intersectsLine(const MexLine3d&, MATHEX_SCALAR*, Accuracy) const
{
    return false;
}
