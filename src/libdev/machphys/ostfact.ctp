...
template <class SUB_TYPE, class PART> MachPhysSubTypedObjectFactory<SUB_TYPE, PART>::~MachPhysSubTypedObjectFactory()
{
    TEST_INVARIANT;
...
template <class SUB_TYPE, class PART> void MachPhysSubTypedObjectFactory<SUB_TYPE, PART>::CLASS_INVARIANT
{
}
