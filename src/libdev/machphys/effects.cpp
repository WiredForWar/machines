...
const MachPhysEffects::Textures& MachPhysEffects::smokeTextures()
{
    ...
    if (firstTime)
    {
        ...
        // Load the textures
        const char* names[]
            = { "smk00_bt.bmp", "smk01_bt.bmp", "smk02_bt.bmp", "smk03_bt.bmp", "smk04_bt.bmp", "smk05_bt.bmp",
                "smk06_bt.bmp", "smk07_bt.bmp", "smk08_bt.bmp", "smk09_bt.bmp", "smk10_bt.bmp", "smk11_bt.bmp",
                "smk12_bt.bmp", "smk13_bt.bmp", "smk14_bt.bmp", "smk15_bt.bmp" };
...
const W4dMaterialPlanPtr& MachPhysEffects::smokeMaterialPlan(SmokeColour smokeColour)
{
    switch (smokeColour)
    {
        case WHITE:
            {
                static W4dMaterialPlanPtr materialPlanPtr(createSmokeMaterialPlan(RenColour(1.0, 1.0, 1.0)));
        ...
        case RUST:
            {
                static W4dMaterialPlanPtr materialPlanPtr(createSmokeMaterialPlan(RenColour(1.0, 62.0 / 255.0, 0.0)));
                return materialPlanPtr;
            }

        case BLACK:
            {
                static W4dMaterialPlanPtr materialPlanPtr(createSmokeMaterialPlan(RenColour(0.0, 0.0, 0.0)));
                return materialPlanPtr;
            }
...
const MachPhysEffects::Textures& MachPhysEffects::flameBallTextures()
{
    ...
    if (firstTime)
    {
        ...
        // Load the textures
        const char* names[] = {
            "ex00_bt.bmp", "ex01_bt.bmp", "ex02_bt.bmp", "ex03_bt.bmp", "ex04_bt.bmp", "ex05_bt.bmp",
            "ex06_bt.bmp", "ex07_bt.bmp", "ex08_bt.bmp", "ex09_bt.bmp", "ex10_bt.bmp", "ex11_bt.bmp",
            "ex12_bt.bmp", "ex13_bt.bmp", "ex14_bt.bmp", "ex15_bt.bmp", "ex16_bt.bmp"
            /*
            "ex17_bt.bmp",
            "ex18_bt.bmp",
            "ex19_bt.bmp",
...
const MachPhysEffects::Textures& MachPhysEffects::flameTextures()
{
    ...
    if (firstTime)
    {
        ...
        // Load the textures
        const char* names[]
            = { "fl00_bt.bmp", "fl01_bt.bmp", "fl02_bt.bmp", "fl03_bt.bmp", "fl04_bt.bmp", "fl05_bt.bmp",
                "fl06_bt.bmp", "fl07_bt.bmp", "fl08_bt.bmp", "fl09_bt.bmp", "fl10_bt.bmp", "fl11_bt.bmp",
                "fl12_bt.bmp", "fl13_bt.bmp", "fl14_bt.bmp", "fl15_bt.bmp" };
...
W4dMaterialSequencePlan* MachPhysEffects::createMaterialSequencePlan(
    const RenMaterial& baseMaterial,
    const Textures& textures,
    uint nMaterialsPerVector,
    const PhysAbsoluteTime& duration,
    W4dLOD maxLOD)
{
