...
PhysRelativeTime
MachPhysTreacheryOrb::beLaunched(const PhysAbsoluteTime& startTime, const MachPhysWeaponData& data, MachPhys::Race race)
{
    PRE(pDisc_ != nullptr);
...
PhysRelativeTime MachPhysTreacheryOrb::suckRaceAt(const PhysAbsoluteTime& destroyTime, MachPhys::Race oldRace)
{
    // get the entity plans for the projectile and the child disc
    W4dEntityPlan& entityPlan = entityPlanForEdit();
    W4dEntityPlan& discEntityPlan = pDisc_->entityPlanForEdit();
