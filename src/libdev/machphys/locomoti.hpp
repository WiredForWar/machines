...
public:
    ...
    using TurnAngles = ctl_vector<MexRadians>;

    virtual void
    moveAnimations(const PhysLinearTravelPlan&, const TurnAngles& turnAngles, const MachPhysMachineMoveInfo& info)
        = 0;
...
protected:
    ...
    static void pitchOrRollAnimation(
        W4dLink* pEntity,
