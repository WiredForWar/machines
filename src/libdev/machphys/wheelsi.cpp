...
std::ostream& operator<<(std::ostream& o, const MachPhysWheelsImpl& t)
{

    o << "MachPhysWheelsImpl " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysWheelsImpl " << static_cast<const void*>(&t) << " end" << std::endl;
