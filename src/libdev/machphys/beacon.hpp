...
{
public:
    MachPhysBeacon(W4dEntity* pParent, const W4dTransform3d& localTransform, size_t level, MachPhys::Race race);

    ~MachPhysBeacon() override;
...
private:
    ...
    using Factory = MachPhysObjectFactory<size_t, MachPhysBeacon>;
