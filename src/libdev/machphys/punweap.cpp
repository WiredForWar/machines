...
std::ostream& operator<<(std::ostream& o, const MachPhysPunchWeapon& t)
{

    o << "MachPhysPunchWeapon " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysPunchWeapon " << static_cast<const void*>(&t) << " end" << std::endl;
