...
static void flameParameters(
    ctl_vector<MexTransform3d>* pPositions,
...
MachPhysEntityDamageImpl::MachPhysEntityDamageImpl(W4dEntity* pTarget)
    ...
    , targetVolume_(
          pTarget_->isComposite() ? pTarget_->asComposite().compositeBoundingVolume() : pTarget_->boundingVolume())
{
    PRE(damageLevel_ >= 0);
          ...
          pTarget_->isComposite() ? pTarget_->asComposite().compositeBoundingVolume() : pTarget_->boundingVolume())
{
    ...
    PRE(ptargetConstruction_ != nullptr);
...
std::ostream& operator<<(std::ostream& o, const MachPhysEntityDamageImpl& t)
{

    o << "MachPhysEntityDamageImpl " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysEntityDamageImpl " << static_cast<const void*>(&t) << " end" << std::endl;
