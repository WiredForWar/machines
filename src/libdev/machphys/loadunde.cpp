...
std::ostream& operator<<(std::ostream& o, const MachPhysLoadingUnder& t)
{

    o << "MachPhysLoadingUnder " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysLoadingUnder " << static_cast<const void*>(&t) << " end" << std::endl;
