...
{
    MachPhysWeapon* pWeapon = nullptr;
...
// static
void MachPhysArmourer::fitWeapons(MachPhysMachine* pMachine, MachPhysCanAttack* pAttacker, MachPhys::WeaponCombo combo)
{
    // fit the weapons
