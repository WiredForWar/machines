...
public:
    ...
    ~MachPhysConstructionData() override;
    ...
    private:
        ...
        void polygonPoints(InteriorExterior type, MexPoint2d* pPoint1, MexPoint2d* pPoint2) const;
    };

    using Entrances = ctl_vector<EntranceData>;
    using Locations = ctl_vector<MexPoint2d>;
    using Polygons = ctl_vector<MexConvexPolygon2d*>;
    ...
    friend std::ostream& operator<<(std::ostream& o, const MachPhysConstructionData& t);
