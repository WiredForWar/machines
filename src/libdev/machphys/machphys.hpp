...
struct MachPhys
{
    ...
    enum AggressorSubType : unsigned char
    {
        GRUNT,
        ASSASSIN,
        KNIGHT,
    ...
    using BuildingMaterialUnits = int;
    using ArmourUnits = int;
    using HitPointUnits = int;
    using ResearchUnits = int;
    using RepairRateUnits = PhysRelativeTime;
    using SizeUnits = int;
    using MineralGrade = int;

    enum FinalState : unsigned char
    {
        AT_REST,
        IN_MOTION
    };
    enum AnimationIds : unsigned char
    {
        ...
        CONSTRUCTION_CONSTRUCTING,
        MACHINE_LOCOMOTION,
        CONSTRUCTION_NOT_WORKING
    };
    enum EntityClientData : unsigned char
    {
        ECD_NODATA = 0,
...
enum MachPhysFireballType : unsigned char
{
    FIREBALL_1,
    FIREBALL_2,
    FIREBALL_3,
