...
public:
    ...
    using LaunchOffsets = ctl_vector<MexPoint3d>;
    using Extras = ctl_vector<MATHEX_SCALAR>;
...
private:
    ...
    bool fixedBurst_; // whether or not the number in a burst varies randomly between 1 and nRoundsPerBurst_ or is
                      // always nRoundsPerBurst_
