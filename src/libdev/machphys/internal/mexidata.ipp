...
_CODE_INLINE
MATHEX_SCALAR MachPhysIMachineExplosionData::maxSize() const
{
    return maxSize_;
}

_CODE_INLINE
size_t MachPhysIMachineExplosionData::maxToShootOff() const
{
...
_CODE_INLINE
const MexPoint3d& MachPhysIMachineExplosionData::explosionCenter() const
{
...
_CODE_INLINE
size_t MachPhysIMachineExplosionData::minToShootOff() const
{
