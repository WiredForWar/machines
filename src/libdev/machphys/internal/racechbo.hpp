...
public:
    ...
    // Types
    using Races = ctl_vector<MachPhys::Race>;
    ...
    changer(const MachPhysMachine& machine, const MachPhysMachineData& data, MachPhys::Race toRace) const;
    ...
    const W4dCompositeMaterialVecChanger& changer(const MachPhysWeapon& weapon, MachPhys::Race toRace) const;
    ...
    friend std::ostream& operator<<(std::ostream& o, const MachPhysRaceChangerBody& t);
...
private:
    ...
    // types
    using MachineChangerMap = ctl_map<MachPhysMachineSpec, W4dCompositeMaterialVecChanger*, MachPhysMachineSpec_Less>;

    using ConstructionChangerMap
        = ctl_map<MachPhysConstructionSpec, W4dCompositeMaterialVecChanger*, MachPhysConstructionSpec_Less>;

    using WeaponChangerMap = ctl_map<MachPhysWeaponSpec, W4dCompositeMaterialVecChanger*, MachPhysWeaponSpec_Less>;
