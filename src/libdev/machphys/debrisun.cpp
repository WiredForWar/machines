    ...
    , boundary_(boundary)
{
    ...
    if (first)
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
            planPtr[i] = W4dMaterialFramePlan::createPlan(this, textures(), 10.0 * overallDuration, 1, i, 2);
        }
    }
...
MachPhysDebrisUnit::MachPhysDebrisUnit(W4dEntity* pParent, const MexTransform3d& transform)
