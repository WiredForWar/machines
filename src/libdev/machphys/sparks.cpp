...
std::ostream& operator<<(std::ostream& o, const MachPhysSparks& t)
{

    o << "MachPhysSparks " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysSparks " << static_cast<const void*>(&t) << " end" << std::endl;
