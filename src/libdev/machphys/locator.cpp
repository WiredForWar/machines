...
std::ostream& operator<<(std::ostream& o, const MachPhysLocator& t)
{

    o << "MachPhysLocator " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysLocator " << static_cast<const void*>(&t) << " end" << std::endl;
