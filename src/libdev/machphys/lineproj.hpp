...
public:
    // dtor
    ~MachPhysLinearProjectile() override;
    ...
    static bool
    impactData(W4dEntity& target, const MexLine3d& fromDirection, MexPoint3d* pImpactPoint, MexVec3* pUnitDirection);
...
private:
    ...
    // Default implementation does nothing.
    virtual void doMove(const MexPoint3d& startPoint, const MexPoint3d& endPoint, const PhysRelativeTime& duration);
