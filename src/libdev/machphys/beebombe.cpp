...
MachPhysBeeBombExplosion::startExplosion(const PhysAbsoluteTime& startTime, const MachPhysPlanetSurface& surface)
{
    ...
    W4dSoundManager::instance().play(this, SID_BEE_DETONATE, startTime, 1);
...
// static
const PhysRelativeTime MachPhysBeeBombExplosion::createFireRings(
    W4dEntity* pParent,
    ...
    const MachPhysPlanetSurface& surface)
{
    ...
    MachPhysCrackFire::createCrackFires(
        pParent,
        position,
        ringPath1(),
        ringStartTime,
        beeWeaponData().extras()[21],
        surface,
        15,
        beeWeaponData().extras()[9],
        MachPhysCrackFire::DEBRIS_NOT_DISPLAY);
    ...
    MachPhysCrackFire::createCrackFires(
        ...
        ringPath2(),
        ringStartTime,
        beeWeaponData().extras()[22],
        surface,
        15,
        beeWeaponData().extras()[10]);
    ...
    MachPhysCrackFire::createCrackFires(
        ...
        ringPath3(),
        ringStartTime,
        beeWeaponData().extras()[23],
        surface,
        15,
        beeWeaponData().extras()[11]);
    ...
    MachPhysCrackFire::createCrackFires(
        ...
        ringPath4(),
        ringStartTime,
        beeWeaponData().extras()[24],
        surface,
        15,
        beeWeaponData().extras()[12]);
    ...
    MachPhysCrackFire::createCrackFires(
        ...
        ringPath5(),
        ringStartTime,
        beeWeaponData().extras()[25],
        surface,
        15,
        beeWeaponData().extras()[13]);
    ...
    MachPhysCrackFire::createCrackFires(
        ...
        ringPath6(),
        ringStartTime,
        beeWeaponData().extras()[26],
        surface,
        15,
        beeWeaponData().extras()[14]);
