...
public:
    ...
    friend std::ostream& operator<<(std::ostream& o, const MachPhysSpyLocator& t);
...
private:
    ...
    using Factory = MachPhysObjectFactory<size_t, MachPhysSpyLocator>;
