    ...
    const MachPhysMachineMoveInfo& info)
{
    ...
    for (; il != leftWheels_.end(); ++il, ++ir)
    {
        ...
        for (size_t i = 0; i < nSegments; ++i)
        {
            ...
            PhysRelativeTime constantVelocityTime = segmentEndTime - lastTime - accelerationTime - decelerationTime;
            ...
            {
                pLPlan->addSegment(accelerationTime, leftForwards ? rotationalAcceleration : -rotationalAcceleration);
                pRPlan->addSegment(accelerationTime, rightForwards ? rotationalAcceleration : -rotationalAcceleration);
            }
            ...
            {
                pLPlan->addSegment(decelerationTime, leftForwards ? -rotationalAcceleration : rotationalAcceleration);
                pRPlan->addSegment(decelerationTime, rightForwards ? -rotationalAcceleration : rotationalAcceleration);
            }
        }
