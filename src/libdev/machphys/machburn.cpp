...
// static
MachPhysMachineBurning::Links MachPhysMachineBurning::burnLinks(const MachPhysMachine& machine, uint nWanted)
{
    ...
    MATHEX_SCALAR percentage)
{
    ...
    // Play burning sound
    W4dSoundManager::instance().playForDuration(pMachine_, SID_BURNING, startTime, duration);
