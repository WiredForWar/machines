...
std::ostream& operator<<(std::ostream& o, const MachPhysParticles& t)
{

    o << "MachPhysParticles " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysParticles " << static_cast<const void*>(&t) << " end" << std::endl;
