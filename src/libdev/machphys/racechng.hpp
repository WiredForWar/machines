...
public:
    ...
    const W4dCompositeMaterialVecChanger& changer(const MachPhysMachine& machine, MachPhys::Race toRace) const;
    ...
    const W4dCompositeMaterialVecChanger&
    changer(const MachPhysConstruction& construction, MachPhys::Race toRace) const;
    ...
    friend std::ostream& operator<<(std::ostream& o, const MachPhysRaceChanger& t);
