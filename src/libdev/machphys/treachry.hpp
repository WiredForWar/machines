...
public:
    ...
    MachPhysTreacheryWeapon(W4dEntity* pParent, const MexTransform3d& localTransform, MachPhys::Mounting mounting);

    // dtor
    ~MachPhysTreacheryWeapon() override;
    ...
    friend std::ostream& operator<<(std::ostream& o, const MachPhysTreacheryWeapon& t);
