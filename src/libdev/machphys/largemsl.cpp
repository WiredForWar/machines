...
std::ostream& operator<<(std::ostream& o, const MachPhysLargeMissile& t)
{

    o << "MachPhysLargeMissile " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysLargeMissile " << static_cast<const void*>(&t) << " end" << std::endl;
