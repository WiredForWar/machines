...
public:
    ...
    victimAnimation(const PhysAbsoluteTime& startTime, const MexLine3d& fromDirection, MachPhysMachine* pMachine) const;
    virtual PhysRelativeTime victimAnimation(
    ...
    friend std::ostream& operator<<(std::ostream& o, const MachPhysWeapon& t);
...
protected:
    ...
    void lighting(
        ...
        MachPhysWeapon::Shadow shadow = NO_SHADOW);
...
#ifdef _INLINE
#include "machphys/Weapons/Weapon.ipp"
#endif
