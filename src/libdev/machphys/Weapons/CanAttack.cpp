...
#include "machphys/Weapons/Internal/CanAttackImpl.hpp"
...
using Weapons = MachPhysCanAttackImpl::Weapons;
...
{
    CB_DEPIMPL(ctl_fixed_vector<W4dLink*>, mountingLinks_);
    return mountingLinks_[mounting] != nullptr;
}
...
void MachPhysCanAttack::mount(MachPhysWeapon* pWeapon, MachPhys::Mounting mounting)
{
    ...
    MachPhysTurnerTracker* pTurnerTracker = nullptr;
...
bool MachPhysCanAttack::hasLaunchedLightWithin(
    ...
    PhysAbsoluteTime firingTime) const
{
