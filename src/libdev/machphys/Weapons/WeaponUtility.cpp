    ...
    MachPhysConstruction* pConstruction)
{
    ...
    switch (type)
    {
        ...
        case MachPhys::PULSE_CANNON:
            {
                duration = MachPhysPulseWeapon::applyVictimAnimation(startTime, fromDirection, pConstruction);
                break;
            }
        ...
        case MachPhys::HEAVY_BOLTER2:
            {
                duration = MachPhysBolter::applyVictimAnimation(startTime, fromDirection, pConstruction);
                break;
            }
        ...
        case MachPhys::FLAME_THROWER2:
            {
                duration = MachPhysFlameThrower::applyVictimAnimation(startTime, fromDirection, pConstruction);
                break;
            }
    }
    ...
    MachPhysArtefact* pArtefact)
{
    ...
    switch (type)
    {
        ...
        case MachPhys::PULSE_CANNON:
            {
                duration = MachPhysPulseWeapon::applyVictimAnimation(startTime, fromDirection, pArtefact);
                break;
            }
        ...
        case MachPhys::HEAVY_BOLTER2:
            {
                duration = MachPhysBolter::applyVictimAnimation(startTime, fromDirection, pArtefact);
                break;
            }
        ...
        case MachPhys::FLAME_THROWER2:
            {
                duration = MachPhysFlameThrower::applyVictimAnimation(startTime, fromDirection, pArtefact);
                break;
            }
    }
