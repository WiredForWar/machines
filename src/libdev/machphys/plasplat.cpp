...
std::ostream& operator<<(std::ostream& o, const MachPhysPlasmaSplat& t)
{

    o << "MachPhysPlasmaSplat " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachPhysPlasmaSplat " << static_cast<const void*>(&t) << " end" << std::endl;
