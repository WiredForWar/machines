...
// virtual
MachPhysLocomotionMethod* MachPhysSpiderLegs::clone(MachPhysMachine* pMachine, const W4dLinks&)
{
...
// virtual
void MachPhysSpiderLegs::moveAnimations(
            ...
            case MachPhysLocomotionMethod::STOPPED:
                {
                    ...
                    pMachine()
                        ->plan(*restingPlanPtr_, SimManager::instance().currentTime(), 0, MachPhys::MACHINE_LOCOMOTION);
                    break;
                }
