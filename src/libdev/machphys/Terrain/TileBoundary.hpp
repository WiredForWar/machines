...
public:
    ...
    void
    profile(MATHEX_SCALAR x1, MATHEX_SCALAR y1, MATHEX_SCALAR x2, MATHEX_SCALAR y2, ctl_vector<MexPoint3d>* pPoints)
        const;
...
private:
    ...
    using TriangleId = unsigned short;
    using CellId = unsigned short;
    using Coordinate = signed char;
    using Heights = ctl_vector<MATHEX_SCALAR>;
    using CellPair = std::pair<CellId, TriangleId>;
    ...
    using Triangles = ctl_vector<TriangleData>;
    using CellPairs = ctl_vector<CellPair>;
