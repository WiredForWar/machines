...
ALCcontext* ALSound::alContext_ = nullptr;
ALCdevice* ALSound::alDevice_ = nullptr;
...
void ALSound::initialise(const SndMixerParameters& params, PriorityLevel p)
{
    ...
    const ALCchar* defaultDeviceName = nullptr; // TODO this should be a parameter
    ...
    listDevices(alcGetString(nullptr, ALC_DEVICE_SPECIFIER));
