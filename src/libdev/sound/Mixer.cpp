...
#include "sound/internal/WaveManager.hpp"
...
{
    static bool soundOn = (getenv("CB_SOUND_OFF") == nullptr);
    return soundOn;
}
...
void SndMixer::initialise(const SndMixerParameters& params)
{
    ...
    if (params.soundSystem() == SndMixerParameters::DIRECTSOUND)
    {
