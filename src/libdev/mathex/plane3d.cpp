...
MexPlane3d::MexPlane3d(const MexPoint3d& p0, const MexPoint3d& p1, const MexPoint3d& p2)
{
    MexVec3 d0 = p0;
    d0 -= p1; // i.e. d0_ = p0 - p1
...
void MexPlane3d::definePlane(const MexPoint3d& p0, const MexPoint3d& p1, const MexPoint3d& p2)
{
