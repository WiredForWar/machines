...
#ifndef _INLINE
#include "mathex/ConvexPolygon2d.ipp"
#endif
...
MexConvexPolygon2d::MexConvexPolygon2d(const MexPoint2d& p1, const MexPoint2d& p2, MATHEX_SCALAR expansionDistance)
    : MexPolygon2d(4)
{
    PRE(expansionDistance > 0);
