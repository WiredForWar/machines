...
#ifndef _INLINE
#include "mathex/AlignedBox2d.ipp"
#endif

//////////////////////////////////////////////////////////////////////
MexAlignedBox2d::MexAlignedBox2d(const MexPoint2d& p1, const MexPoint2d& p2)
    : vmin_(p1)
    , vmax_(p2)
{
...
MexAlignedBox2d::MexAlignedBox2d(const MexPoint2d& p1, const MexPoint2d& p2, MATHEX_SCALAR clearance)
    : isEmpty_(false)
{
    PRE(clearance >= 0);
