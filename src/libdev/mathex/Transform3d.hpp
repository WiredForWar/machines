...
public:
    ...
    MexTransform3d(const MexVec3& xBasis, const MexVec3& yBasis, const MexVec3& zBasis, const MexPoint3d& position);
...
private:
    ...
    static void
    multiplyMatrices(const MexTransformMatrix3d a, const MexTransformMatrix3d b, MexTransformMatrix3d result);
