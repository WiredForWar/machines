...
inline MexDouble::MexDouble(Cardinality c)
    : rep_(0.0, c)
{
    // Intentionally Empty
}
...
inline bool MexDouble::isPlusInfinity() const
{
    return rep_.cardinality_ == PLUS_INFINITY;
}

inline bool MexDouble::isMinusInfinity() const
{
    return rep_.cardinality_ == MINUS_INFINITY;
}

inline bool MexDouble::isInfinite() const
{
    return rep_.cardinality_ != FINITE;
}

inline const MexDouble& MexDouble::plusInfinity()
{
    static MexDouble result_(PLUS_INFINITY);
    return result_;
}

inline const MexDouble& MexDouble::minusInfinity()
{
    static MexDouble result_(MINUS_INFINITY);
    return result_;
}

inline MexDouble::Classification MexDouble::classification(const MexDouble& a, const MexDouble& b)
{
    return Classification((a.rep_.cardinality_ << CARD_BITS) | b.rep_.cardinality_);
}

inline MexDouble MexDouble::operator-() const
{
...
inline bool operator<(const MexDouble& a, const MexDouble& b)
{
    bool result = false;
...
inline MexDouble operator+(const MexDouble& a, const MexDouble& b)
{
    MexDouble result = a;
