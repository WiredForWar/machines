...
MexQuad3d::MexQuad3d(const MexPoint3d& v1, const MexPoint3d& v2, const MexPoint3d& v3, const MexPoint3d& v4)
{
    vertices_[0] = v1;
    vertices_[1] = v2;
    vertices_[2] = v3;
...
{
    return vertices_[0] == q.vertices_[0] && vertices_[1] == q.vertices_[1] && vertices_[2] == q.vertices_[2]
        && vertices_[3] == q.vertices_[3];
}
