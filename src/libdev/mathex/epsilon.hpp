...
public:
    ...
    static MATHEX_SCALAR clampTo(MATHEX_SCALAR valueToBeClamped, MATHEX_SCALAR valueToClampTo);

    //  Returns true iff the two values are within epsilon of each other.
    static bool isWithinEpsilonOf(MATHEX_SCALAR value1, MATHEX_SCALAR value2);
