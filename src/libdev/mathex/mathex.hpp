...
template <class T> bool inIntervalOO(const T& t, const T& lBound, const T& uBound);

template <class T> bool inIntervalCC(const T& t, const T& lBound, const T& uBound);

template <class T> bool inIntervalOC(const T& t, const T& lBound, const T& uBound);

template <class T> bool inIntervalCO(const T& t, const T& lBound, const T& uBound);
...
template <class T1> T1 mexClamp(const T1& inputValue, const T1& lowerLimit, const T1& upperLimit);
...
template <class SCALAR> class MexYCoord
{
public:
    MexYCoord(SCALAR s)
        : data_(s)
