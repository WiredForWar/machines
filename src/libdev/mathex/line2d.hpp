...
public:
    ...
    sqrEuclidianDistance(const MexPoint2d& p1, const MexPoint2d& p2, MATHEX_SCALAR length, const MexPoint2d& q);
    // PRE( length > epsilon );
    ...
    static Mathex::Side side(const MexPoint2d& q1, const MexPoint2d& q2, const MexPoint2d& r);
