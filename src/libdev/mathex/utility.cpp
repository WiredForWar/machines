...
// static
bool MexUtility::inStraightLine(const MexPoint2d& p1, const MexPoint2d& p2, const MexPoint2d& p3)
{
    bool result;
...
// static
uint MexUtility::quadraticRealRoots(
    MATHEX_SCALAR a,
    MATHEX_SCALAR b,
    MATHEX_SCALAR c,
    MATHEX_SCALAR* pRoot1,
    MATHEX_SCALAR* pRoot2)
{
    PRE_INFO(a);
    PRE_INFO(b);
    PRE_INFO(c);
...
void MexUtility::slideAlongPolygon(
    ...
    const MexVec2& motionDirection,
    MATHEX_SCALAR distance,
    Point2ds* pSlidePoints)
{
