...
#ifndef _INLINE
#include "mathex/Transform3d.ipp"
#endif
    ...
    , flags_(t.flags_)
{
    ...
    forward_[0][1] = t.forward_[0][1];
    forward_[0][2] = t.forward_[0][2];
    forward_[1][0] = t.forward_[1][0];
    forward_[1][1] = t.forward_[1][1];
    forward_[1][2] = t.forward_[1][2];
    forward_[2][0] = t.forward_[2][0];
    forward_[2][1] = t.forward_[2][1];
    forward_[2][2] = t.forward_[2][2];
    forward_[3][0] = t.forward_[3][0];
    forward_[3][1] = t.forward_[3][1];
    forward_[3][2] = t.forward_[3][2];
    ...
    : flags_(GENERAL)
{
    ...
    forward_[0][0] = xBasis[0];
    forward_[0][1] = xBasis[1];
    forward_[0][2] = xBasis[2];
    forward_[1][0] = yBasis[0];
    forward_[1][1] = yBasis[1];
    forward_[1][2] = yBasis[2];
    forward_[2][0] = zBasis[0];
    forward_[2][1] = zBasis[1];
    forward_[2][2] = zBasis[2];
    forward_[3][0] = position[0];
    forward_[3][1] = position[1];
    forward_[3][2] = position[2];
...
void MexTransform3d::translate(const MexPoint3d& translation)
{
    ...
    forward_[3][0]
        += translation.x() * forward_[0][0] + translation.y() * forward_[1][0] + translation.z() * forward_[2][0];

    forward_[3][1]
        += translation.x() * forward_[0][1] + translation.y() * forward_[1][1] + translation.z() * forward_[2][1];

    forward_[3][2]
        += translation.x() * forward_[0][2] + translation.y() * forward_[1][2] + translation.z() * forward_[2][2];
...

{
    ...
    forward_[3][0]
        += t.forward_[3][0] * forward_[0][0] + t.forward_[3][1] * forward_[1][0] + t.forward_[3][2] * forward_[2][0];

    forward_[3][1]
        += t.forward_[3][0] * forward_[0][1] + t.forward_[3][1] * forward_[1][1] + t.forward_[3][2] * forward_[2][1];

    forward_[3][2]
        += t.forward_[3][0] * forward_[0][2] + t.forward_[3][1] * forward_[1][2] + t.forward_[3][2] * forward_[2][2];
...

{
    ...
    newRotation[0][0]
        = t.forward_[0][0] * forward_[0][0] + t.forward_[0][1] * forward_[1][0] + t.forward_[0][2] * forward_[2][0];
    newRotation[0][1]
        = t.forward_[0][0] * forward_[0][1] + t.forward_[0][1] * forward_[1][1] + t.forward_[0][2] * forward_[2][1];
    newRotation[0][2]
        = t.forward_[0][0] * forward_[0][2] + t.forward_[0][1] * forward_[1][2] + t.forward_[0][2] * forward_[2][2];

    newRotation[1][0]
        = t.forward_[1][0] * forward_[0][0] + t.forward_[1][1] * forward_[1][0] + t.forward_[1][2] * forward_[2][0];
    newRotation[1][1]
        = t.forward_[1][0] * forward_[0][1] + t.forward_[1][1] * forward_[1][1] + t.forward_[1][2] * forward_[2][1];
    newRotation[1][2]
        = t.forward_[1][0] * forward_[0][2] + t.forward_[1][1] * forward_[1][2] + t.forward_[1][2] * forward_[2][2];

    newRotation[2][0]
        = t.forward_[2][0] * forward_[0][0] + t.forward_[2][1] * forward_[1][0] + t.forward_[2][2] * forward_[2][0];
    newRotation[2][1]
        = t.forward_[2][0] * forward_[0][1] + t.forward_[2][1] * forward_[1][1] + t.forward_[2][2] * forward_[2][1];
    newRotation[2][2]
        = t.forward_[2][0] * forward_[0][2] + t.forward_[2][1] * forward_[1][2] + t.forward_[2][2] * forward_[2][2];

    forward_[0][0] = newRotation[0][0];
    forward_[0][1] = newRotation[0][1];
    forward_[0][2] = newRotation[0][2];
    forward_[1][0] = newRotation[1][0];
    forward_[1][1] = newRotation[1][1];
    forward_[1][2] = newRotation[1][2];
    forward_[2][0] = newRotation[2][0];
    forward_[2][1] = newRotation[2][1];
    forward_[2][2] = newRotation[2][2];
...

{
    ...
    forward_[0][0] = newTransform[0][0];
    forward_[0][1] = newTransform[0][1];
    forward_[0][2] = newTransform[0][2];
    forward_[1][0] = newTransform[1][0];
    forward_[1][1] = newTransform[1][1];
    forward_[1][2] = newTransform[1][2];
    forward_[2][0] = newTransform[2][0];
    forward_[2][1] = newTransform[2][1];
    forward_[2][2] = newTransform[2][2];
    forward_[3][0] = newTransform[3][0];
    forward_[3][1] = newTransform[3][1];
    forward_[3][2] = newTransform[3][2];
...

{
    ...
    newXform[0][1]
        = forward_[1][0] * t.forward_[0][0] + forward_[1][1] * t.forward_[0][1] + forward_[1][2] * t.forward_[0][2];
    newXform[0][2]
        = forward_[2][0] * t.forward_[0][0] + forward_[2][1] * t.forward_[0][1] + forward_[2][2] * t.forward_[0][2];

    newXform[1][0]
        = forward_[0][0] * t.forward_[1][0] + forward_[0][1] * t.forward_[1][1] + forward_[0][2] * t.forward_[1][2];
    newXform[1][1]
        = forward_[1][0] * t.forward_[1][0] + forward_[1][1] * t.forward_[1][1] + forward_[1][2] * t.forward_[1][2];
    newXform[1][2]
        = forward_[2][0] * t.forward_[1][0] + forward_[2][1] * t.forward_[1][1] + forward_[2][2] * t.forward_[1][2];

    newXform[2][0]
        = forward_[0][0] * t.forward_[2][0] + forward_[0][1] * t.forward_[2][1] + forward_[0][2] * t.forward_[2][2];
    newXform[2][1]
        = forward_[1][0] * t.forward_[2][0] + forward_[1][1] * t.forward_[2][1] + forward_[1][2] * t.forward_[2][2];
    newXform[2][2]
        = forward_[2][0] * t.forward_[2][0] + forward_[2][1] * t.forward_[2][1] + forward_[2][2] * t.forward_[2][2];

    newXform[3][0] = forward_[0][0] * t.forward_[3][0] + forward_[0][1] * t.forward_[3][1]
        + forward_[0][2] * t.forward_[3][2] + invT[0];
    newXform[3][1] = forward_[1][0] * t.forward_[3][0] + forward_[1][1] * t.forward_[3][1]
        + forward_[1][2] * t.forward_[3][2] + invT[1];
    newXform[3][2] = forward_[2][0] * t.forward_[3][0] + forward_[2][1] * t.forward_[3][1]
        + forward_[2][2] * t.forward_[3][2] + invT[2];
...
void MexTransform3d::preTransformInverse(const MexTransform3d& t)
{
    ...
    newXform[0][0]
        = t.forward_[0][0] * forward_[0][0] + t.forward_[1][0] * forward_[1][0] + t.forward_[2][0] * forward_[2][0];
    newXform[0][1]
        = t.forward_[0][1] * forward_[0][0] + t.forward_[1][1] * forward_[1][0] + t.forward_[2][1] * forward_[2][0];
    newXform[0][2]
        = t.forward_[0][2] * forward_[0][0] + t.forward_[1][2] * forward_[1][0] + t.forward_[2][2] * forward_[2][0];

    newXform[1][0]
        = t.forward_[0][0] * forward_[0][1] + t.forward_[1][0] * forward_[1][1] + t.forward_[2][0] * forward_[2][1];
    newXform[1][1]
        = t.forward_[0][1] * forward_[0][1] + t.forward_[1][1] * forward_[1][1] + t.forward_[2][1] * forward_[2][1];
    newXform[1][2]
        = t.forward_[0][2] * forward_[0][1] + t.forward_[1][2] * forward_[1][1] + t.forward_[2][2] * forward_[2][1];

    newXform[2][0]
        = t.forward_[0][0] * forward_[0][2] + t.forward_[1][0] * forward_[1][2] + t.forward_[2][0] * forward_[2][2];
    newXform[2][1]
        = t.forward_[0][1] * forward_[0][2] + t.forward_[1][1] * forward_[1][2] + t.forward_[2][1] * forward_[2][2];
    newXform[2][2]
        = t.forward_[0][2] * forward_[0][2] + t.forward_[1][2] * forward_[1][2] + t.forward_[2][2] * forward_[2][2];

    newXform[3][0]
        = t.forward_[0][0] * invT[0] + t.forward_[1][0] * invT[1] + t.forward_[2][0] * invT[2] + t.forward_[3][0];
    newXform[3][1]
        = t.forward_[0][1] * invT[0] + t.forward_[1][1] * invT[1] + t.forward_[2][1] * invT[2] + t.forward_[3][1];
    newXform[3][2]
        = t.forward_[0][2] * invT[0] + t.forward_[1][2] * invT[1] + t.forward_[2][2] * invT[2] + t.forward_[3][2];
...
//---------------------------------------------------------------------------------------
// static
void MexTransform3d::multiplyMatrices(
    const MexTransformMatrix3d a,
    const MexTransformMatrix3d b,
...
bool MexTransform3d::operator==(const MexTransform3d& t) const
{
    ...
    bool match = Mathex::abs(forward_[0][0] - t.forward_[0][0]) < MexEpsilon::instance()
...
bool MexTransform3d::operator==(const MATHEX_SCALAR t[4][4]) const
{
    ...
    bool match = Mathex::abs(forward_[0][0] - t[0][0]) < MexEpsilon::instance()
...

{
    ...
    pTransform->forward_[3][0]
        = -(forward_[3][0] * pTransform->forward_[0][0] + forward_[3][1] * pTransform->forward_[1][0]
            + forward_[3][2] * pTransform->forward_[2][0]);

    pTransform->forward_[3][1]
        = -(forward_[3][0] * pTransform->forward_[0][1] + forward_[3][1] * pTransform->forward_[1][1]
            + forward_[3][2] * pTransform->forward_[2][1]);

    pTransform->forward_[3][2]
        = -(forward_[3][0] * pTransform->forward_[0][2] + forward_[3][1] * pTransform->forward_[1][2]
...

{
    ...
    ok = Mathex::abs(forward_[0][0] - MATHEX_SCALAR(1.0)) < MexEpsilon::instance()
        && Mathex::abs(forward_[0][1]) < MexEpsilon::instance() && Mathex::abs(forward_[0][2]) < MexEpsilon::instance();

    ok = ok && Mathex::abs(forward_[1][0]) < MexEpsilon::instance()
        && Mathex::abs(forward_[1][1] - MATHEX_SCALAR(1.0)) < MexEpsilon::instance()
        && Mathex::abs(forward_[1][2]) < MexEpsilon::instance();

    ok = ok && Mathex::abs(forward_[2][0]) < MexEpsilon::instance()
        && Mathex::abs(forward_[2][1]) < MexEpsilon::instance()
        && Mathex::abs(forward_[2][2] - MATHEX_SCALAR(1.0)) < MexEpsilon::instance();

    ok = ok && Mathex::abs(forward_[3][0]) < MexEpsilon::instance()
        && Mathex::abs(forward_[3][1]) < MexEpsilon::instance() && Mathex::abs(forward_[3][2]) < MexEpsilon::instance();
...
std::ostream& operator<<(std::ostream& stream, const MexTransform3d& t)
{
    ...
    stream << std::setprecision(4) << std::setw(14) << t.forward_[1][0] << " " << t.forward_[1][1] << " "
           << t.forward_[1][2] << std::endl;
    stream << std::setprecision(4) << std::setw(14) << t.forward_[2][0] << " " << t.forward_[2][1] << " "
           << t.forward_[2][2] << std::endl;
    stream << std::setprecision(4) << std::setw(14) << t.forward_[3][0] << " " << t.forward_[3][1] << " "
           << t.forward_[3][2] << std::endl;
    ...
    const MexPoint3d& position)
{
    ...
    forward_[0][0] = xBasis.x();
    forward_[0][1] = xBasis.y();
    forward_[0][2] = xBasis.z();
    forward_[1][0] = yBasis.x();
    forward_[1][1] = yBasis.y();
    forward_[1][2] = yBasis.z();
    forward_[2][0] = zBasis.x();
    forward_[2][1] = zBasis.y();
    forward_[2][2] = zBasis.z();
    forward_[3][0] = position[0];
    forward_[3][1] = position[1];
    forward_[3][2] = position[2];
}
