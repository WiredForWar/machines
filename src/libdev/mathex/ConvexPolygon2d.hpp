...
public:
    ...
    // p1 to p2.
    MexConvexPolygon2d(const MexPoint2d& p1, const MexPoint2d& p2, MATHEX_SCALAR expansionDistance);
    ...
    // dtor.
    ~MexConvexPolygon2d() override;

    // The ith vertex
    const MexPoint2d& vertex(size_t i) const override;
