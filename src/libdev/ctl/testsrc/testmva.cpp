...
//  static
void TestMinMemoryVectorAssert::invalidateIterator(
...
//  static
void TestMinMemoryVectorAssert::dontInvalidateIterator(
    const TestMinMemoryVectorType::iterator& i,
    TestMinMemoryVectorType& vector)
{
    PRE(i != vector.end());
...
void TestMinMemoryVectorAssert::getValidRandomIterator(
    TestMinMemoryVectorType& vector,
    size_t* pIndex,
...
//  static
void TestMinMemoryVectorAssert::getValidRandomIteratorInclusive(
    TestMinMemoryVectorType& vector,
    size_t* pIndex,
    TestMinMemoryVectorType::iterator* pI)
{
...
//  static
void TestMinMemoryVectorAssert::getIterator(
    TestMinMemoryVectorType& vector,
    size_t index,
    TestMinMemoryVectorType::iterator* pI)
{
...
//  static
void TestMinMemoryVectorAssert::getRangeIncluding(
    const TestMinMemoryVectorType::iterator& i,
