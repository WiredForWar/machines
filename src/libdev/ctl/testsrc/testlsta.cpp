...
//  static
TestListAssert::TestListType::iterator
TestListAssert::iteratorThatIsnt(const TestListType::iterator& i, TestListType& list)
{
...
//  static
void TestListAssert::getRangeIncluding(
...
//  static
void TestListAssert::getRangeExcluding(
    const TestListType::iterator& i,
    TestListType& list,
    TestListType::iterator* pFrom,
    TestListType::iterator* pTo)
