...
template <class T> class ctl_pvector : public ctl_nb_vector<T*>
{
public:
...
template <class T> bool operator==(const ctl_pvector<T>&, const ctl_pvector<T>&);

// #ifdef _INSTANTIATE_TEMPLATE_FUNCTIONS
#include "ctl/PtrVector.ctf"
// #endif
