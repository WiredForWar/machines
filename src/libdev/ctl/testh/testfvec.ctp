...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::operatorSquareBrackets()
{
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorAddition(void)
{
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorAddEquals(void)
{
    size_t index = TestFixedVectorAssert::randomIndex1();
    size_t n = TestFixedVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorSubtraction(void)
{
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorSubtractEquals(void)
{
    int index = TestFixedVectorAssert::randomIndex1();
    int n = TestFixedVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorSquareBrackets(void)
{
    int index = TestFixedVectorAssert::randomIndex1();
    int n = TestFixedVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorPlusPlusPrefix(void)
{
    size_t index = TestFixedVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorPlusPlusPostfix(void)
{
    size_t index = TestFixedVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorMinusMinusPrefix(void)
{
    size_t index = TestFixedVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorOperatorMinusMinusPostfix(void)
{
    size_t index = TestFixedVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorDereference(void)
{
    size_t index = TestFixedVectorAssert::randomIndex1();
...
//  static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorComparison(void)
{
    Destinations dA;
    Destinations dB;
    ...
    if (dA == VECTOR1 && indexA <= TestFixedVectorAssert::vector1Size() && dB == VECTOR1
        && indexB <= TestFixedVectorAssert::vector1Size())
        TestFixedVectorAssert::instance().expectedResult(SoakTestAssert::SUCCEED);

    if (dA == VECTOR2 && indexA <= TestFixedVectorAssert::vector2Size() && dB == VECTOR2
        && indexB <= TestFixedVectorAssert::vector2Size())
        TestFixedVectorAssert::instance().expectedResult(SoakTestAssert::SUCCEED);
...
template <class VECTOR, class ITERATOR> TestFixedVector<VECTOR, ITERATOR>::~TestFixedVector()
{
    TEST_INVARIANT;
}

// static
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::iteratorInvalidation(void)
{
    size_t index;
    TestIterator i;
...
template <class VECTOR, class ITERATOR> void TestFixedVector<VECTOR, ITERATOR>::CLASS_INVARIANT
{
}

template <class VECTOR, class ITERATOR> ostream& operator<<(ostream& o, const TestFixedVector<VECTOR, ITERATOR>& t)
{
