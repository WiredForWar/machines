...
template <class T> class ctl_fixed_vector : public std::vector<T>
{
public:
    using value_type = T;
...
template <class T> bool operator==(const ctl_fixed_vector<T>&, const ctl_fixed_vector<T>&);
