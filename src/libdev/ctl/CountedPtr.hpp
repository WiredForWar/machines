...
private:
    ...
    friend bool operator< <>(const CtlCountedPtr<T> a, const CtlCountedPtr<T> b);
    ...
    friend const typename CtlCountHolder<T>::pointer& ctl_cp_holder(const CtlCountedPtr& t) { return t.pCount_; }
    friend typename CtlCountHolder<T>::pointer& ctl_cp_holder(CtlCountedPtr& t) { return t.pCount_; }
};
...
public:
    ...
    CtlConstCountedPtr(T* tPtr = nullptr);
...
private:
    ...
    friend bool operator< <>(const CtlConstCountedPtr<T> a, const CtlConstCountedPtr<T> b);
    ...
    friend const typename CtlCountHolder<T>::pointer& ctl_cp_holder(const CtlConstCountedPtr& t) { return t.pCount_; }
    friend typename CtlCountHolder<T>::pointer& ctl_cp_holder(CtlConstCountedPtr& t) { return t.pCount_; }
};
