...
public:
    ...
    using W4dPortals = ctl_list<W4dPortal*>;
    ...
    W4dPortal* addPortal(W4dDomain* pPartner, const MexQuad3d& aperture, const W4dTransform3d& newLocalTransform);
