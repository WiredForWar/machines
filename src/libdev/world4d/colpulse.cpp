...
std::ostream& operator<<(std::ostream& o, const W4dColourPulsePlan& t)
{
    ...
    o << "W4dColourPulsePlan " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "W4dColourPulsePlan " << static_cast<const void*>(&t) << " end" << std::endl;
...
// virtual
const Ren::MaterialVecPtr& W4dColourPulsePlan::materialVec(const PhysRelativeTime& timeOffset, W4dLOD lodId) const
{
...
// static
void W4dColourPulsePlan::makePlan(
    W4dEntity* pEntity,
    const ColourPulseDataVec& dataVec,
...
// static
void W4dColourPulsePlan::changeAllColour(
    W4dEntity* pEntity,
    const RenColour& fromColour,
    const RenColour& toColour,
