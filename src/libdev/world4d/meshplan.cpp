...
void W4dMeshPlan::add(const SysPathName& pathName, const PhysRelativeTime& endTime, const MexTransform3d& transform)
{
    // Checks
    PRE(endTime > 0.0);
...
void W4dMeshPlan::renderAtRange(
