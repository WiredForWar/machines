...
std::ostream& operator<<(std::ostream& o, const W4dLightData& t)
{
    ...
    o << "W4dLightData " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "W4dLightData " << static_cast<const void*>(&t) << " end" << std::endl;
