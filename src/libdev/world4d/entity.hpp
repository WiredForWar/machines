...
public:
    ...
    using W4dEntities = ctl_list<W4dEntity*>;
    ...
    using W4dDomains = ctl_list<W4dDomain*>;
    ...
    bool hasContainingDomain(W4dDomain** ppDomain = nullptr) const;
    ...
    // Default implementation is adequate for entities. Should only be overridden by
    // W4dComposite class.
    virtual void propogateScalePlan(
...
private:
    ...
    void updateLODUVTransforms(const Ren::UVTransformPtr& uvTransformPtr, W4dLOD maxLOD, W4dLOD exceptId);
...
private:
    ...
    bool
    rangeToMesh(const W4dDistance& range, RenMeshInstance** ppMesh, W4dLOD* pLodId, const W4dComplexity& complexity)
        const;
    ...
    virtual void temporaryScale(const RenNonUniformScale& scale, const MexTransform3d& useTransform);
