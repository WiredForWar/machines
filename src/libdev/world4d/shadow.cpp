...
// virtual
W4dEntity::RenderType W4dShadowProjected2d::render(const W4dCamera& cam, W4dComplexity& comp)
{
    cast(shadowPlaneZ_);
...
// virtual
bool W4dShadow::intersectsLine(const MexLine3d& line, MATHEX_SCALAR* pDistance, Accuracy accuracy) const
{
