...
#ifndef _INLINE
#include "world4d/Scene/CameraShake.ipp"
#endif

static PhysMotionPlanPtr
shakePlanPtr(const uint& nPositions, const MATHEX_SCALAR& angle, const PhysRelativeTime& duration);
