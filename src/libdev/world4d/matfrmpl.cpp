...
std::ostream& operator<<(std::ostream& o, const W4dMaterialFramePlan& t)
{
    ...
    o << "W4dMaterialFramePlan " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "W4dMaterialFramePlan " << static_cast<const void*>(&t) << " end" << std::endl;
...
// static
bool W4dMaterialFramePlan::makePlan(
    W4dEntity* pEntity,
    const ctl_vector<RenTexture>& textures,
    ...
    W4dLOD maxLOD)
{
    W4dMaterialPlanPtr materialPlanPtr(
        W4dMaterialFramePlan::createPlan(pEntity, textures, duration, frameReps, startFrame, maxLOD));
...
// static
W4dMaterialFramePlan* W4dMaterialFramePlan::createPlan(
    W4dEntity* pEntity,
    const ctl_vector<RenTexture>& textures,
    const PhysRelativeTime& duration,
    uint frameReps,
...
{
    bool Found = false;
    W4dMaterialFramePlan* pMaterialFramePlan = nullptr;
