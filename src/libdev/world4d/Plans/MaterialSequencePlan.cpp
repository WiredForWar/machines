...
#ifndef _INLINE
#include "world4d/Plans/MaterialSequencePlan.ipp"
#endif
...
// virtual
const Ren::MaterialVecPtr& W4dMaterialSequencePlan::materialVec(const PhysRelativeTime& timeOffset, W4dLOD lodId) const
{
    PRE(timeOffset >= 0.0);
    PRE(isLODDefined(lodId));
    TEST_INVARIANT;
...
// static
bool W4dMaterialSequencePlan::makePlan(
    W4dEntity* pEntity,
...
// static
bool W4dMaterialSequencePlan::changeTexture(
    W4dEntity* pEntity,
    const RenTexture& fromTexture,
    const RenTexture& toTexture)
{
    bool found = false;
