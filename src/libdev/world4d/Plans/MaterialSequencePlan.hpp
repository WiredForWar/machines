...
public:
    ...
    W4dMaterialSequencePlan(const MaterialVecPtrs& materialVecPtrs, const PhysRelativeTime& duration, W4dLOD maxLOD);

    // dtor
    ~W4dMaterialSequencePlan() override;
