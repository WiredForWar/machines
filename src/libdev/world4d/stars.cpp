...
W4dStars::W4dStars(W4dEntity* pParent, RenStars::Configuration config, MATHEX_SCALAR radius, uint nStars)
...
// VIRTUAL //
bool W4dStars::intersectsLine(const MexLine3d& line, MATHEX_SCALAR* pDistance, Accuracy accuracy) const
{
...
W4dEntity::RenderType W4dStars::render(const W4dCamera& camera, W4dComplexity&)
{
    ...
    pStars_->render(opacity_, camera.globalTransform(), camera.verticalFOVAngle(), camera.horizontalFOVAngle());
