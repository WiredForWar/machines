...
std::ostream& operator<<(std::ostream& o, const W4dCompositeMaterialVecChanger& t)
{
    ...
    o << "W4dCompositeMaterialVecChanger " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "W4dCompositeMaterialVecChanger " << static_cast<const void*>(&t) << " end" << std::endl;
...
{
    return pCompositeChanger_ != nullptr;
}
...
const W4dEntityMaterialVecChanger& W4dCompositeMaterialVecChanger::linkChanger(size_t index) const
{
    PRE(index < nLinkChangers());
...
const W4dEntityMaterialVecChanger& W4dCompositeMaterialVecChanger::linkIdChanger(W4dLinkId linkId) const
{
