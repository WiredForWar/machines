...
public:
    ...
    void add(const SysPathName& pathName, const PhysRelativeTime& endTime, const MexTransform3d& transform);
...
private:
    ...
    using MeshInterval = std::pair<W4dEntity*, PhysRelativeTime>;
    using MeshIntervals = ctl_vector<MeshInterval>;
