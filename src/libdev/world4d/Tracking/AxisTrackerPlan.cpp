...
#ifndef _INLINE
#include "world4d/Tracking/AxisTrackerPlan.ipp"
#endif

W4dAxisTrackerPlan::W4dAxisTrackerPlan(
    const W4dEntity& turningObject,
    W4dEntity& targetObject,
...
std::ostream& operator<<(std::ostream& o, const W4dAxisTrackerPlan& t)
{
    ...
    o << "W4dAxisTrackerPlan " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "W4dAxisTrackerPlan " << static_cast<const void*>(&t) << " end" << std::endl;
...
void W4dAxisTrackerPlan::transform(const PhysRelativeTime& timeOffset, MexTransform3d* pResult) const
{
    ...
    {
        case W4d::X_AXIS:
            angles.roll(theAngle);
            break;
        case W4d::Y_AXIS:
            angles.elevation(theAngle);
            break;
        case W4d::Z_AXIS:
            angles.azimuth(theAngle);
            break;
    }
...
MexRadians W4dAxisTrackerPlan::currentAngle()
{
    ...
    switch (turningAxis_)
    {
        case W4d::X_AXIS:
            ...
            break;
        case W4d::Y_AXIS:
            angle = angles.elevation();
            break;
        case W4d::Z_AXIS:
            angle = angles.azimuth();
            break;
