...
public:
    ...
    void transform(const PhysRelativeTime& timeOffset, MexTransform3d* result) const override;
    /////////////////////////////////////////////
...
private:
    friend std::ostream& operator<<(std::ostream& o, const W4dAxisTrackerPlan& t);
