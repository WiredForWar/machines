...
public:
    ...
    using ColourPulseDataVec = ctl_pvector<W4dColourPulseData>;
    ...
    // find the material in the MatVec of pEntity which uses texture, then change its colour to color, return true if
    // found
