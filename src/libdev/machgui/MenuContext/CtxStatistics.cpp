...
#include "machgui/internal/PlayerScore.hpp"
    ...
    , delayBarsGrowth_(2)
{
    ...
    new MachGuiMenuText(
        ...
        Gui::Box(
            ...
            font.horizontalAdvance(generalHeading.asString()),
            font.height() + 2),
        IDS_MENU_STSGENERAL,
    ...
    new MachGuiMenuText(
        ...
        Gui::Box(
            ...
            font.horizontalAdvance(BARHeading.asString()),
            font.height() + 2),
        IDS_MENU_STSBAR,
        MachGui::Menu::smallFontWhite(),
        Gui::AlignLeft);
    ...
    new MachGuiMenuText(
        ...
        Gui::Box(
            ...
            font.horizontalAdvance(killsHeading.asString()),
            font.height() + 2),
        IDS_MENU_STSKILLS,
        MachGui::Menu::smallFontWhite(),
        Gui::AlignLeft);
