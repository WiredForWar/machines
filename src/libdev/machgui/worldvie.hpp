...
{
public:
    MachWorldViewWindow(MachInGameScreen* pParent, const Gui::Boundary& relativeBox, MachCameras* pCameras);

    ~MachWorldViewWindow() override;
...
private:
    ...
    // world space.
    void dispatchCursor(const MexLine3d& cursorLine, bool click, bool ctrlPressed, bool shiftPressed, bool altPressed);

    void updateActorsSelectedViaRubberBand(
        bool highlightOnly,
        bool keepSelection,
