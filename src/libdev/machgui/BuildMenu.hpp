...
private:
    ...
    MachBuildMenu(const MachBuildMenu&) = delete;
    MachBuildMenu& operator=(const MachBuildMenu&) = delete;
    bool operator==(const MachBuildMenu&) = delete;
