...
#include "machgui/BuildMachineIcon.hpp"
...
{
    return 42 * Gui::uiScaleFactor(); // TODO : remove hardcoded value
}
...
void MachBuildMachineIcon::doHandleMouseEnterEvent(const GuiMouseEvent& mouseEvent)
{
    ...
    const GuiString cost
        = std::format("{}{}", GuiBmpFont::bmuPointsIndex(), researchItem_.factoryInstanceCost());
