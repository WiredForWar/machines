...
#include "machgui/typeContinentMap.hpp"
...
const MachLog::ObjectType& MachLogType::type() const
{
    return type_;
}
...
MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doBeacon()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doFactory()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doGarrison()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doHardwareLab()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doPod()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doMine()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doMissileEmplacement()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doSoftwareLab()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doSmelter()
{
    return doDefault();
}
...
MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doAdministrator()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doBoss()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doOverseer()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doCommander()
{
    return doDefault();
}
...
MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doAggressor()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doAssassin()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doBallista()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doGrunt()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doKnight()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doNinja()
{
    return doDefault();
}
...
MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doConstructor()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doDozer()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doBuilder()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doBehemoth()
{
    return doDefault();
}
...
MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doLocator()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doGeoLocator()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doSpyLocator()
{
    return doDefault();
}
...
MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doTechnician()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doLabTechTechnician()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doTechBoyTechnician()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doBrainBoxTechnician()
{
    return doDefault();
}
...
MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doTransporter()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doResourceCarrier()
{
    return doDefault();
}

MachLogTypeMap::ProcessAsSubtype MachLogTypeMap::doPersonnelCarrier()
{
    return doDefault();
}
