...
{
    static const Gui::Colour c = Gui::Colour::fromString("#101863").value_or({});
    return c;
}

const Gui::Colour lightTextColor()
{
    static const Gui::Colour c = Gui::Colour::fromString("#e5dd95").value_or({});
    return c;
}

const Gui::Colour focusedTextColor()
{
    static const Gui::Colour c = Gui::Colour::fromString("#f4e900").value_or({});
    return c;
}
