...
void MachGuiStartupData::PlayerInfo::setPlayerName(const string& playerName)
{
    ...
    DEBUG_STREAM(
        DIAG_NEIL,
        "MachGuiStartupData::PlayerInfo::setPlayerName " << playerName << " " << playerName_ << std::endl);
...
void MachGuiStartupData::receivedUpdatePlayersMessage()
{
    ...
    else
    {
        NETWORK_ERRORS_STREAM(
            "NW03: receivedUpdatePlayersMessage but pCtxImReady was NULL so I'm not doing anything with it\n");
    }
}
...
std::ostream& operator<<(std::ostream& o, const MachGuiStartupData::PlayerInfo::Status& t)
{
    switch (t)
    {
        case MachGuiStartupData::PlayerInfo::COMPUTER:
            o << "COMPUTER";
            break;
        case MachGuiStartupData::PlayerInfo::OPEN:
            o << "OPEN";
            break;
        case MachGuiStartupData::PlayerInfo::CLOSED:
            o << "CLOSED";
            break;
        case MachGuiStartupData::PlayerInfo::HUMAN:
            o << "HUMAN";
            break;
        case MachGuiStartupData::PlayerInfo::UNAVAILABLE:
            o << "UNAVAILABLE";
            break;
        default:
            o << "Unknown status in MachGuiStartupData::PlayerInfo::Status " << std::endl;
    }
    return o;
}
