...
#include "machgui/TypeRestorer.hpp"
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessBeacon(MachLogBeacon* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessFactory(MachLogFactory* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessGarrison(MachLogGarrison* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessHardwareLab(MachLogHardwareLab* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessPod(MachLogPod* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessMine(MachLogMine* pActor)
{
    return doDefaultProcess(pActor);
}
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessSmelter(MachLogSmelter* pActor)
{
    return doDefaultProcess(pActor);
}
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessAdministrator(MachLogAdministrator* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessBoss(MachLogAdministrator* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessOverseer(MachLogAdministrator* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessCommander(MachLogAdministrator* pActor)
{
    return doDefaultProcess(pActor);
}
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessAggressor(MachLogAggressor* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessAssassin(MachLogAggressor* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessBallista(MachLogAggressor* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessGrunt(MachLogAggressor* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessKnight(MachLogAggressor* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessNinja(MachLogAggressor* pActor)
{
    return doDefaultProcess(pActor);
}
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessConstructor(MachLogConstructor* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessDozer(MachLogConstructor* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessBuilder(MachLogConstructor* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessBehemoth(MachLogConstructor* pActor)
{
    return doDefaultProcess(pActor);
}
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessLocator(MachLogMachine* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessGeoLocator(MachLogGeoLocator* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessSpyLocator(MachLogSpyLocator* pActor)
{
    return doDefaultProcess(pActor);
}
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessTechnician(MachLogTechnician* pActor)
{
    return doDefaultProcess(pActor);
}
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessLabTechTechnician(MachLogTechnician* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessTechBoyTechnician(MachLogTechnician* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessBrainBoxTechnician(MachLogTechnician* pActor)
{
    return doDefaultProcess(pActor);
}
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessTransporter(MachLogMachine* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessResourceCarrier(MachLogResourceCarrier* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessPersonnelCarrier(MachLogAPC* pActor)
{
    return doDefaultProcess(pActor);
}

/* //////////////////////////////////////////////////////////////// */
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessCivilianHardwareLab(MachLogHardwareLab* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessMilitaryHardwareLab(MachLogHardwareLab* pActor)
{
    return doDefaultProcess(pActor);
}
...
MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessTurret(MachLogMissileEmplacement* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessSentry(MachLogMissileEmplacement* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessLauncher(MachLogMissileEmplacement* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessICBM(MachLogMissileEmplacement* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessMilitaryFactory(MachLogFactory* pActor)
{
    return doDefaultProcess(pActor);
}

MachLogTypeRestorer::ProcessAsSubtype MachLogTypeRestorer::doProcessCivilianFactory(MachLogFactory* pActor)
{
    return doDefaultProcess(pActor);
}
