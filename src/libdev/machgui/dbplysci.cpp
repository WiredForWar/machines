...
std::ostream& operator<<(std::ostream& o, const MachGuiDbIPlayerScenario& t)
{

    o << "MachGuiDbIPlayerScenario " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachGuiDbIPlayerScenario " << static_cast<const void*>(&t) << " end" << std::endl;
