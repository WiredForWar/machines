...
std::ostream& operator<<(std::ostream& o, const MachGuiIonAttackCommand& t)
{

    o << "MachGuiIonAttackCommand " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachGuiIonAttackCommand " << static_cast<const void*>(&t) << " end" << std::endl;

    return o;
}

// virtual
void MachGuiIonAttackCommand::pickOnTerrain(
...
// virtual
void MachGuiIonAttackCommand::pickOnActor(MachActor* pActor, bool ctrlPressed, bool shiftPressed, bool altPressed)
{
...
// virtual
std::unique_ptr<MachGuiCommand> MachGuiIonAttackCommand::clone() const
{
    return std::make_unique<MachGuiIonAttackCommand>(&inGameScreen());
}
