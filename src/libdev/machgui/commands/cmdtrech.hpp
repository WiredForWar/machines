...
public:
    ...
    // dtor
    ~MachGuiTreacheryCommand() override;
    ...
    friend std::ostream& operator<<(std::ostream& o, const MachGuiTreacheryCommand& t);
...
private:
    ...
    bool applyTreacheryObject(MachActor* pActor, std::string* pReason);
