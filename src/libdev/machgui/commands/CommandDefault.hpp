...
private:
    ...
    MachGuiDefaultCommand(const MachGuiDefaultCommand&) = delete;
    MachGuiDefaultCommand& operator=(const MachGuiDefaultCommand&) = delete;
    bool operator==(const MachGuiDefaultCommand&) = delete;
