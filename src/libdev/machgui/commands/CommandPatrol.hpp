...
private:
    ...
    MachGuiPatrolCommand(const MachGuiPatrolCommand&) = delete;
    MachGuiPatrolCommand& operator=(const MachGuiPatrolCommand&) = delete;
    bool operator==(const MachGuiPatrolCommand&) = delete;
