...
private:
    ...
    MachGuiConstructCommand(const MachGuiConstructCommand&) = delete;
    MachGuiConstructCommand& operator=(const MachGuiConstructCommand&) = delete;
    bool operator==(const MachGuiConstructCommand&) = delete;
