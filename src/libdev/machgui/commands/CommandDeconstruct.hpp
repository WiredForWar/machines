...
private:
    ...
    MachGuiDeconstructCommand(const MachGuiDeconstructCommand&) = delete;
    MachGuiDeconstructCommand& operator=(const MachGuiDeconstructCommand&) = delete;
    bool operator==(const MachGuiDeconstructCommand&) = delete;
