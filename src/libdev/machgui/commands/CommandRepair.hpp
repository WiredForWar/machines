...
private:
    ...
    MachGuiRepairCommand(const MachGuiRepairCommand&) = delete;
    MachGuiRepairCommand& operator=(const MachGuiRepairCommand&) = delete;
    bool operator==(const MachGuiRepairCommand&) = delete;
