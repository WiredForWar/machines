...
private:
    ...
    MachGuiScavengeCommand(const MachGuiScavengeCommand&) = delete;
    MachGuiScavengeCommand& operator=(const MachGuiScavengeCommand&) = delete;
    bool operator==(const MachGuiScavengeCommand&) = delete;
