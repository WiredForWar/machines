...
private:
    ...
    MachGuiBuildCommand(const MachGuiBuildCommand&) = delete;
    MachGuiBuildCommand& operator=(const MachGuiBuildCommand&) = delete;
    bool operator==(const MachGuiBuildCommand&) = delete;
