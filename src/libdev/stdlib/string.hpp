...
template <class T> class basic_string : public std::basic_string<T>
{
public:
    ...
    basic_string() { }
    basic_string(const std::basic_string<T>& s)
    ...
    template <class T1> friend void perWrite(PerOstream&, const basic_string<T1>&);
    template <class T1> friend void perRead(PerIstream&, basic_string<T1>&);
