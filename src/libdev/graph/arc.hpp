...
template <class ARC_ITEM, class VERTEX_ID, class WEIGHT> class GraArc
...
public:
    ...
    GraArc(const ArcItem& item, const VertexId& from, const VertexId& to);
    // POST( weight() == 1 );
...
#include "graph/arc_templates.hpp"
// #endif
