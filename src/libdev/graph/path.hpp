...
template <class VERTEX_ID, class ADJACENT_VERTICES, class IS_DEST_VERTEX> class GraShortestPath
...
public:
    ...
    GraShortestPath(const AdjacentVertices&, const VertexId& source, const IsDestVertex& isDest);
...
private:
    ...
    typedef pair<MapJourneyIdToVertexId::const_iterator, MapJourneyIdToVertexId::const_iterator>
        MapJourneyIdToVertexIdRange;
