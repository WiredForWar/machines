...
template <class VI, class VT, class AI, class AT, class AIS, class W>
typename GraGraphBase<VI, VT, AI, AT, AIS, W>::ArcCount GraGraphBase<VI, VT, AI, AT, AIS, W>::nArcs() const
{
    return nArcs_;
}

template <class VI, class VT, class AI, class AT, class AIS, class W>
typename GraGraphBase<VI, VT, AI, AT, AIS, W>::VertexCount GraGraphBase<VI, VT, AI, AT, AIS, W>::nVertices() const
{
    return nVertices_;
}

template <class VI, class VT, class AI, class AT, class AIS, class W>
typename GraGraphBase<VI, VT, AI, AT, AIS, W>::Version GraGraphBase<VI, VT, AI, AT, AIS, W>::version() const
{
    return version_;
}
...
template <class VI, class VT, class AI, class AT, class AIS, class W>
void GraGraphBase<VI, VT, AI, AT, AIS, W>::removeVertex(const VertexId& id)
{
    PRE(containsVertex(id));
    POST_DATA(VertexCount old_nVertices = nVertices());
...
template <class VI, class VT, class AI, class AT, class AIS, class W>
void GraGraphBase<VI, VT, AI, AT, AIS, W>::addArc(
    const VertexId& from,
    const VertexId& to,
    const ArcId& arcId,
...
template <class VI, class VT, class AI, class AT, class AIS, class W>
void GraGraphBase<VI, VT, AI, AT, AIS, W>::removeArc(const ArcId& id)
{
    PRE(containsArc(id));
