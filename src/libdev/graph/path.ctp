...
GraShortestPath<VERTEX_ID, ADJACENT_VERTICES, IS_DEST>::GraShortestPath(
    const AdjacentVertices& adj,
...
template <class VERTEX_ID, class ADJACENT_VERTICES, class IS_DEST>
bool GraShortestPath<VERTEX_ID, ADJACENT_VERTICES, IS_DEST>::isFinished() const
{
...
template <class VERTEX_ID, class ADJACENT_VERTICES, class IS_DEST>
void GraShortestPath<VERTEX_ID, ADJACENT_VERTICES, IS_DEST>::restart(const VertexId& source)
{
    source_ = source;
...
template <class VERTEX_ID, class ADJACENT_VERTICES, class IS_DEST>
bool GraShortestPath<VERTEX_ID, ADJACENT_VERTICES, IS_DEST>::isAdjacentTo(const VertexId& from, const VertexId& to)
    const
{
