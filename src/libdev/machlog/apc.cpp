...
// static
MachPhysAPC* MachLogAPC::pNewPhysAPC(Level hwLevel, Level swLevel, MachLogRace* pRace, const MexPoint3d& location)
{
...
// virtual
void MachLogAPC::beHitWithoutAnimation(
    int damage,
...
const MachPhys::BuildingMaterialUnits& MachLogAPC::amountCarried() const
{
    CB_MachLogAPC_DEPIMPL();
...
MachPhys::BuildingMaterialUnits& MachLogAPC::amountCarried()
{
    CB_MachLogAPC_DEPIMPL();
    return amountCarried_;
}
...
const MachLogAPC::Machines& MachLogAPC::machines() const
{
    CB_MachLogAPC_DEPIMPL();
...
bool MachLogAPC::nextDeployPoint(MexPoint3d* pDest3d, MATHEX_SCALAR clearanceOfDeployed)
{
    ...
    spaceAvailable = MachLogSpacialManipulation::getNearestFreeSpacePoint(
        apcTransform,
        highClearence() + 10,
        clearanceOfDeployed * 1.5,
        &freePoint);
...
// virtual
PhysRelativeTime MachLogAPC::update(const PhysRelativeTime& maxCPUTime, MATHEX_SCALAR clearance)
{
    CB_MachLogAPC_DEPIMPL();
...
void MachLogAPC::turnRearToFaceNearestIncoming()
{
    ...
    MexRadians newAngle
        = (MachLogSpacialManipulation::angleToTurnToFace(*this, currentNearestMachine().position())
...
const MachLogMachine& MachLogAPC::currentNearestMachine() const
{
    ...
    MachLogMachine* pCurrentNearest = nullptr;
...
void perRead(PerIstream& istr, MachLogAPC& actor)
{
    ...
    MachPhysAPC* pPhysAPC
        = MachLogAPC::pNewPhysAPC(base1.hwLevel(), base1.swLevel(), &actor.logRace(), trans.position());
...
// virtual
bool MachLogAPC::beNotified(W4dSubject* pSubject, W4dSubject::NotificationEvent event, int /*clientData*/)
{
    CB_MachLogAPC_DEPIMPL();
