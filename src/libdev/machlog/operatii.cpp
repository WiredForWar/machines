...
std::ostream& operator<<(std::ostream& o, const MachLogOperationImpl& t)
{

    o << "MachLogOperationImpl " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachLogOperationImpl " << static_cast<const void*>(&t) << " end" << std::endl;
