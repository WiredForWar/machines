...
public:
    ...
    newLogOreHolograph(MachPhys::Race race, int concentration, int quantity, const MexPoint3d& location);

    // Return a new instance of a logical oreholo
    static MachLogOreHolograph*
    newLogOreHolograph(MachPhys::Race race, int concentration, int quantity, const MexPoint3d& location, UtlId withId);

    // Return a new instance of a logical debris
    static MachLogDebris*
    newLogDebris(MachPhys::Race race, int quantity, const MexPoint3d& location, const MexAlignedBox2d& boundary);
    ...
    static MachLogLandMine* newLogLandMine(MachPhys::Race race, const MexPoint3d& location);

    // Return a new instance of a logical land mine
    static MachLogLandMine* newLogLandMine(MachPhys::Race race, const MexPoint3d& location, UtlId withId);

    // Return a new instance of a logical artefact
    static MachLogArtefact* newLogArtefact(int subType, const MexPoint3d& location, const MexRadians& angle);

    // Return a new instance of a logical artefact
    static MachLogArtefact*
    newLogArtefact(int subType, const MexPoint3d& location, const MexRadians& angle, UtlId withId);

    // Return a new dumb artefact (no logical actor involved), located in the appropriate domain
    static W4dEntity* newDumbArtefact(int subType, const MexPoint3d& location, const MexRadians& angle);
