...
// consdata.ipp never existed on disk; was compiled via Unity Build
...
void MachLogConstructionData::addEntrance(const MexPoint2d& externalPoint, const MexPoint2d& internalPoint)
{
