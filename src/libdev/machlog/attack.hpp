...
class MachLogAttackOperation : public MachLogOperation
{
public:
    enum RaceChangeTerminate
    {
        TERMINATE_ON_CHANGE,
        DO_NOT_TERMINATE_ON_CHANGE
    };
    ...
    ~MachLogAttackOperation() override;
...
private:
    ...
    Action
    actionForDisposition(MachLogCanAttack::WeaponDisposition worstDisposition, const MachLogCanAttack& attacker) const;
    PhysRelativeTime calculateNewApproachPoint(
