...
public:
    enum MachLogMessageCode : uint8
    {
        ...
        RESYNC_TIME_CODE,
        BE_HIT_CODE,
        MACHINE_SET_DOMAIN_CODE,
        MACHINE_TURN_CODE,
        ADD_RESTING_OBSTACLE_CODE,
        REQUEST_ADD_RESTING_OBSTACLE_CODE,
        ADJUST_HP_AND_ARMOUR_CODE,
        CLEAR_RESTING_OBSTACLE_CODE,
        STOP_DEAD_CODE,
        ADD_MOTION_CHUNKS_CODE,
        REQUEST_ADD_MOTION_CHUNKS_CODE,
        MOTION_CHUNKS_FAILED_CODE,
        ADD_MOVING_OBSTACLE_CODE,
        REQUEST_ADD_MOVING_OBSTACLE_CODE,
        CLEAR_MOVING_CHUNKS_CODE,
        FIRE_WEAPON_ANIMATION_CODE,
        UPDATE_COMPLETION_VISUALISATION_CODE,
        ECHO_LINEAR_PROJECTILE_CODE,
        CREATE_SPECIAL_ACTOR_CODE,
        CREATE_SPECIAL_WEAPON_EFFECT_CODE,
        APPLY_SPECIAL_WEAPON_ANIMATION_CODE,
        PLAY_NORMAL_OBJECT_ANIMATION_CODE,
        USE_SPACE_DOMAIN_CODE,
        SET_SITE_DISCOVERED_BY_CODE,
        NEW_RESEARCH_CODE,
        HEAL_CODE,
        REMOVE_CONSTRUCTION_CODE,
        CHANGE_RACE_CODE,
        DEBRIS_EXPIRED_CODE,
        LOAD_ARTEFACT_MODELS_CODE,
        ADD_NEW_ARTEFACT_SUB_TYPE_CODE,
        ADD_ARTEFACT_DAMAGE_LINK_CODE,
        MACHINE_CAMOUFLAGE_CHANGED_CODE,
        CURRENT_TARGET_CODE,
        FIRST_PERSON_END_CODE,
        FIRST_PERSON_UPDATE_CODE,
        PLAY_CONSTRUCT_ANIMATION_CODE,
        ENTERED_BUILDING_CODE,
        EXTRACT_ORE_CODE,
        WEAPON_INFORMATION_CODE,
        ADD_RESTING_OBSTACLE_SHORT_CODE,
        START_GAME_CODE,
        LOST_FLAG_SET_CODE,
        ECHO_NEW_SCORE_CODE,
        ACTOR_THREAT_CODE,
        CHANGE_OF_DISPOSITION_CODE,
        SMELT_MACHINE_CODE,
        ADVANCE_CONSTRUCTION_STATE_CODE,
        ADD_REPAIR_POINTS_CODE,
        MAKE_COMPLETE_CONSTRUCTION_CODE,
        IS_ENTRANCE_OPEN_CODE,
        N_CODES
    };

    enum BeHitType : uint8
    {
        NORMAL_HIT,
        NO_ANIMATION_HIT
    };
    enum ActorNowDead : uint8
    {
        ACTOR_NOT_DEAD,
        ACTOR_DEAD
    };
    ...
    enum HealingFlag : uint8
    {
        BEGIN_HEALING,
        STOP_HEALING
    };
    enum CamouflageFlag : uint8
    {
        BEGIN_CAMOUFLAGE,
        STOP_CAMOUFLAGE
    };
    enum WeaponInfoFlag : uint8
    {
        ION_CANNON_FIRED,
        NUKE_FIRED,
        ION_CANNON_ONLINE,
...
#pragma pack(pop)
    ...
    using ProjectileDestroyData = ctl_pvector<SingleProjectileDestroyData>;
    ...
    void
    sendRequestAddMovingObstaclesMessage(UtlId whichId, const MexPoint3d& start, const MexPoint3d& end, int status);
    ...
    void sendEchoLinearProjectileMessage(
        UtlId whichId,
        MachPhys::Mounting whichGun,
        UtlId targetId,
        const PhysAbsoluteTime& launchTime,
        int nRounds,
        const ProjectileDestroyData&,
        const MexPoint3d& terrainPosition);
    void sendCreateSpecialActorMessage(
        MachPhys::Race race,
        MachLog::ObjectType ot,
        int quantity,
        const MexPoint3d& position,
    ...
    void sendChangeOfDispositionMessage(
        MachPhys::Race,
        MachPhys::Race,
        int); // note last paramter is actually a MLRaces::DispositionToRace
