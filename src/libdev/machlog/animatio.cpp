...
{
//In operation//    MachPhys::BuildingMaterialUnits amountToAdd = ( units_ * ( SimManager::instance().currentTime() -
lastUpdateTime_ ) / 60 );
//In operation//    MachPhys::BuildingMaterialUnits& nBMU = MachLogRaces::instance().nBuildingMaterialUnits(
pActor_->race() );
//In operation//
