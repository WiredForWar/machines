...
void MachLogMessageBroker::processMessage(NetMessage* pMessage)
{
    ...
    NET_ANALYSIS_STREAM(
        "in," << systemCode << "," << code << "," << SimManager::instance().currentTime() << ","
              << pLogMessage->header_.totalLength_ << std::endl);
    switch (code)
    {
...
std::ostream& operator<<(std::ostream& o, const MachLogMessageBroker::MachLogMessageCode& t)
{
    switch (t)
    {
        case MachLogMessageBroker::CREATE_ACTOR_CODE:
            o << "CREATE_ACTOR_CODE";
            break;
        case MachLogMessageBroker::CREATE_SPECIAL_ACTOR_CODE:
            o << "CREATE_SPECIAL_ACTOR_CODE";
            break;
        case MachLogMessageBroker::MACHINE_MOVE_CODE:
            o << "MACHINE_MOVE_CODE";
            break;
        case MachLogMessageBroker::READY_CODE:
            o << "READY_CODE";
            break;
        case MachLogMessageBroker::RESYNC_TIME_CODE:
            o << "RESYNC_TIME_CODE:";
            break;
        case MachLogMessageBroker::BE_HIT_CODE:
            o << "BE_HIT_CODE:";
            break;
        case MachLogMessageBroker::MACHINE_SET_DOMAIN_CODE:
            o << "MACHINE_SET_DOMAIN_CODE:";
            break;
        case MachLogMessageBroker::MACHINE_TURN_CODE:
            o << "MACHINE_TURN_CODE:";
            break;
        case MachLogMessageBroker::ADD_RESTING_OBSTACLE_CODE:
            o << "ADD_RESTING_OBSTACLE_CODE:";
            break;
        case MachLogMessageBroker::ADD_RESTING_OBSTACLE_SHORT_CODE:
            o << "ADD_RESTING_OBSTACLE_SHORT_CODE:";
            break;
        case MachLogMessageBroker::REQUEST_ADD_RESTING_OBSTACLE_CODE:
            o << "REQUEST_ADD_RESTING_OBSTACLE_CODE:";
            break;
        case MachLogMessageBroker::ADJUST_HP_AND_ARMOUR_CODE:
            o << "ADJUST_HP_AND_ARMOUR_CODE:";
            break;
        case MachLogMessageBroker::CLEAR_RESTING_OBSTACLE_CODE:
            o << "CLEAR_RESTING_OBSTACLE_CODE:";
            break;
        case MachLogMessageBroker::STOP_DEAD_CODE:
            o << "STOP_DEAD_CODE:";
            break;
        case MachLogMessageBroker::ADD_MOTION_CHUNKS_CODE:
            o << "ADD_MOTION_CHUNKS_CODE:";
            break;
        case MachLogMessageBroker::REQUEST_ADD_MOTION_CHUNKS_CODE:
            o << "REQUEST_ADD_MOTION_CHUNKS_CODE:";
            break;
        case MachLogMessageBroker::MOTION_CHUNKS_FAILED_CODE:
            o << "MOTION_CHUNKS_FAILED_CODE:";
            break;
        case MachLogMessageBroker::ADD_MOVING_OBSTACLE_CODE:
            o << "ADD_MOVING_OBSTACLE_CODE:";
            break;
        case MachLogMessageBroker::REQUEST_ADD_MOVING_OBSTACLE_CODE:
            o << "REQUEST_ADD_MOVING_OBSTACLE_CODE:";
            break;
        case MachLogMessageBroker::CLEAR_MOVING_CHUNKS_CODE:
            o << "CLEAR_MOVING_CHUNKS_CODE:";
            break;
        case MachLogMessageBroker::FIRE_WEAPON_ANIMATION_CODE:
            o << "FIRE_WEAPON_ANIMATION_CODE:";
            break;
        case MachLogMessageBroker::UPDATE_COMPLETION_VISUALISATION_CODE:
            o << "UPDATE_COMPLETION_VISUALISATION_CODE:";
            break;
        case MachLogMessageBroker::CREATE_SPECIAL_WEAPON_EFFECT_CODE:
            o << "CREATE_SPECIAL_WEAPON_EFFECT_CODE:";
            break;
        case MachLogMessageBroker::APPLY_SPECIAL_WEAPON_ANIMATION_CODE:
            o << "APPLY_SPECIAL_WEAPON_ANIMATION_CODE:";
            break;
        case MachLogMessageBroker::ECHO_LINEAR_PROJECTILE_CODE:
            o << "ECHO_LINEAR_PROJECTILE_CODE";
            break;
        case MachLogMessageBroker::PLAY_NORMAL_OBJECT_ANIMATION_CODE:
            o << "PLAY_NORMAL_OBJECT_ANIMATION_CODE";
            break;
        case MachLogMessageBroker::USE_SPACE_DOMAIN_CODE:
            o << "USE_SPACE_DOMAIN_CODE";
            break;
        case MachLogMessageBroker::WEAPON_INFORMATION_CODE:
            o << "WEAPON_INFORMATION_CODE";
            break;
        case MachLogMessageBroker::SET_SITE_DISCOVERED_BY_CODE:
            o << "SET_SITE_DISCOVERED_BY_CODE";
            break;
        case MachLogMessageBroker::EXTRACT_ORE_CODE:
            o << "EXTRACT_ORE_CODE";
            break;
        case MachLogMessageBroker::NEW_RESEARCH_CODE:
            o << "NEW_RESEARCH_CODE";
            break;
        case MachLogMessageBroker::HEAL_CODE:
            o << "HEAL_CODE";
            break;
        case MachLogMessageBroker::REMOVE_CONSTRUCTION_CODE:
            o << "REMOVE_CONSTRUCTION_CODE";
            break;
        case MachLogMessageBroker::CHANGE_RACE_CODE:
            o << "CHANGE_RACE_CODE";
            break;
        case MachLogMessageBroker::DEBRIS_EXPIRED_CODE:
            o << "DEBRIS_EXPIRED_CODE";
            break;
        case MachLogMessageBroker::LOAD_ARTEFACT_MODELS_CODE:
            o << "LOAD_ARTEFACT_MODELS_CODE";
            break;
        case MachLogMessageBroker::ADD_NEW_ARTEFACT_SUB_TYPE_CODE:
            o << "ADD_NEW_ARTEFACT_SUB_TYPE_CODE";
            break;
        case MachLogMessageBroker::ADD_ARTEFACT_DAMAGE_LINK_CODE:
            o << "ADD_ARTEFACT_DAMAGE_LINK_CODE";
            break;
        case MachLogMessageBroker::MACHINE_CAMOUFLAGE_CHANGED_CODE:
            o << "MACHINE_CAMOUFLAGE_CHANGED_CODE";
            break;
        case MachLogMessageBroker::CURRENT_TARGET_CODE:
            o << "CURRENT_TARGET_CODE";
            break;
        case MachLogMessageBroker::FIRST_PERSON_END_CODE:
            o << "FIRST_PERSON_END_CODE";
            break;
        case MachLogMessageBroker::FIRST_PERSON_UPDATE_CODE:
            o << "FIRST_PERSON_UPDATE_CODE";
            break;
        case MachLogMessageBroker::PLAY_CONSTRUCT_ANIMATION_CODE:
            o << "PLAY_CONSTRUCT_ANIMATION_CODE";
            break;
        case MachLogMessageBroker::ENTERED_BUILDING_CODE:
            o << "ENTERED_BUILDING_CODE";
            break;
        case MachLogMessageBroker::START_GAME_CODE:
            o << "START_GAME_CODE";
            break;
        case MachLogMessageBroker::LOST_FLAG_SET_CODE:
            o << "LOST_FLAG_SET_CODE";
            break;
        case MachLogMessageBroker::ECHO_NEW_SCORE_CODE:
            o << "ECHO_NEW_SCORE_CODE";
            break;
        case MachLogMessageBroker::ACTOR_THREAT_CODE:
            o << "ACTOR_THREAT_CODE";
            break;
        case MachLogMessageBroker::CHANGE_OF_DISPOSITION_CODE:
            o << "CHANGE_OF_DISPOSITION_CODE";
            break;
        case MachLogMessageBroker::SMELT_MACHINE_CODE:
            o << "SMELT_MACHINE_CODE";
            break;
        case MachLogMessageBroker::ADVANCE_CONSTRUCTION_STATE_CODE:
            o << "ADVANCE_CONSTRUCTION_STATE_CODE";
            break;
        case MachLogMessageBroker::ADD_REPAIR_POINTS_CODE:
            o << "ADD_REPAIR_POINTS_CODE";
            break;
        case MachLogMessageBroker::MAKE_COMPLETE_CONSTRUCTION_CODE:
            o << "MAKE_COMPLETE_CONSTRUCTION_CODE";
            break;
        case MachLogMessageBroker::IS_ENTRANCE_OPEN_CODE:
            o << "IS_ENTRANCE_OPEN_CODE";
            break;
        default:
...
std::ostream& operator<<(std::ostream& o, const MachLogMessageBroker::ActorNowDead& t)
{
    switch (t)
    {
        case MachLogMessageBroker::ACTOR_NOT_DEAD:
            o << "ACTOR_NOT_DEAD";
            break;
        case MachLogMessageBroker::ACTOR_DEAD:
            o << "ACTOR_DEAD";
            break;
        default:
            ASSERT_BAD_CASE;
