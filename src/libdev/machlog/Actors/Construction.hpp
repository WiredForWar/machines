...
public:
    ...
    void makeComplete(
        CompleteWithFullHPs setHPsFullStrength
        = HP_STRENGTH_UNALTERED); // if explicitly set true, bumps all HPs up to full whack.
    ...
    MachPhys::BuildingMaterialUnits bmuValueOfHitPoints(MachPhys::HitPointUnits HPs) const;
