...
// virtual
void MachLogAdministrator::beHit(
    const int& damage,
...
// virtual
void MachLogAdministrator::beHitWithoutAnimation(
    int damage,
...
void perRead(PerIstream& istr, MachLogAdministrator& actor)
{
    ...
    MachPhysAdministrator* pPhysAdministrator = MachLogAdministrator::pNewPhysAdministrator(
        actor.subType_,
        base1.hwLevel(),
        base1.swLevel(),
        &actor.logRace(),
