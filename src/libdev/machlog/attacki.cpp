...
{
    nextHardCoverCheckTime_
        = SimManager::instance().currentTime() + MachLogAttackOperation::behindCoverMoveGracePeriod();
    TEST_INVARIANT;
}
...
std::ostream& operator<<(std::ostream& o, const MachLogAttackOperationImpl& t)
{

    o << "MachLogAttackOperationImpl " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachLogAttackOperationImpl " << static_cast<const void*>(&t) << " end" << std::endl;
...
void perRead(PerIstream& istr, MachLogAttackOperationImpl& attackOpImpl)
{
    ...
    attackOpImpl.nextHardCoverCheckTime_
        = SimManager::instance().currentTime() + MachLogAttackOperation::behindCoverMoveGracePeriod();
