...
#include "machlog/Internal/MissileEmplacementAttackOperationImpl.hpp"
...
// virtual
bool MachLogMissileEmplacementAttackOperation::beNotified(
    W4dSubject* pSubject,
...
void MachLogMissileEmplacementAttackOperation::CLASS_INVARIANT
{
    ...
    INVARIANT(iff(pDirectObject_ != nullptr, currentlyAttached_));
}
