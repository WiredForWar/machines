...
PhysRelativeTime MachLogGotoLabOperation::doUpdate()
{
    ...
    // No software labs??    {
    // No software labs??        MachLogRaces::SoftwareLabs::iterator j = MachLogRaces::instance().softwareLabs(
    // pActor_->race() ).begin(); No software labs?? No software labs??        for( MachLogRaces::SoftwareLabs::iterator
    // i = MachLogRaces::instance().softwareLabs( pActor_->race() ).begin(); No software labs??            i !=
