...
void MachLogSuperConstructOperation::doOutputOperator(std::ostream& o) const
{
...
PhysRelativeTime MachLogSuperConstructOperation::doUpdate()
{
    ...
    {
        case MachLogOperation::CONSTRUCT_OPERATION:
            subOperation(pActor_, std::make_unique<MachLogConstructOperation>(pActor_, pTargetConstruction));
            break;

        case MachLogOperation::DECONSTRUCT_OPERATION:
            subOperation(pActor_, std::make_unique<MachLogDeconstructOperation>(pActor_, pTargetConstruction));
            break;

        case MachLogOperation::CAPTURE_OPERATION:
            subOperation(pActor_, std::make_unique<MachLogCaptureOperation>(pActor_, pTargetConstruction));
            break;

        case MachLogOperation::REPAIR_OPERATION:
            subOperation(pActor_, std::make_unique<MachLogRepairOperation>(pActor_, pTargetConstruction));
            break;
...
// virtual
bool MachLogSuperConstructOperation::beNotified(
    W4dSubject* pSubject,
