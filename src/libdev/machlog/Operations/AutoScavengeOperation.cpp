...
#include "machlog/Internal/AutoScavengeOperationImpl.hpp"
...
// virtual
bool MachLogAutoScavengeOperation::beNotified(
    W4dSubject* pSubject,
...
PhysRelativeTime MachLogAutoScavengeOperation::doUpdate()
{
    ...
    ASSERT(
        ...
        "MachLogAutoScavengeOperation::doUpdate : Hey, we shouldn't have a null pointer for the cached op by now!");
    ...
    ASSERT(pDebris_ != nullptr, "pDebris_ shouldn't be NULL if we've decided not to break off the attack.");
