...
#include "machlog/Internal/TransportOperationImpl.hpp"
...
PhysRelativeTime MachLogTransportOperation::doUpdate()
{
    CB_MachLogTransportOperation_DEPIMPL();
...
{
    o << "MachLogTransportOperation " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachLogTransportOperation " << static_cast<const void*>(&t) << " end" << std::endl;
