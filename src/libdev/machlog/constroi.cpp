...
std::ostream& operator<<(std::ostream& o, const MachLogConstructionImpl& t)
{

    o << "MachLogConstructionImpl " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachLogConstructionImpl " << static_cast<const void*>(&t) << " end" << std::endl;
