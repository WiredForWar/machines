...
MachLogRaces::Machines& MachLogRaces::machines()
{
...
bool MachLogRaces::addMatchingMachineToSquadron(
    MachPhys::Race r,
    const MachLogProductionUnit& prod,
    MachLogSquadron* pSquadron)
{
    bool found = false;
...
MachLogRaces::Aggressors& MachLogRaces::aggressors(MachPhys::Race r)
{
    return pDataImpl_->aggressors_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Aggressors& MachLogRaces::aggressors(MachPhys::Race r) const
{
    return pDataImpl_->aggressors_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Administrators& MachLogRaces::administrators(MachPhys::Race r)
{
    return pDataImpl_->administrators_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Administrators& MachLogRaces::administrators(MachPhys::Race r) const
{
    return pDataImpl_->administrators_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Technicians& MachLogRaces::technicians(MachPhys::Race r)
{
    return pDataImpl_->technicians_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Technicians& MachLogRaces::technicians(MachPhys::Race r) const
{
    return pDataImpl_->technicians_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Constructors& MachLogRaces::constructors(MachPhys::Race r)
{
    return pDataImpl_->constructors_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Constructors& MachLogRaces::constructors(MachPhys::Race r) const
{
    return pDataImpl_->constructors_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::GeoLocators& MachLogRaces::geoLocators(MachPhys::Race r)
{
    return pDataImpl_->geoLocators_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::GeoLocators& MachLogRaces::geoLocators(MachPhys::Race r) const
{
    return pDataImpl_->geoLocators_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::SpyLocators& MachLogRaces::spyLocators(MachPhys::Race r)
{
    return pDataImpl_->spyLocators_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::SpyLocators& MachLogRaces::spyLocators(MachPhys::Race r) const
{
    return pDataImpl_->spyLocators_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::ResourceCarriers& MachLogRaces::resourceCarriers(MachPhys::Race r)
{
    return pDataImpl_->resourceCarriers_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::ResourceCarriers& MachLogRaces::resourceCarriers(MachPhys::Race r) const
{
    return pDataImpl_->resourceCarriers_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::APCs& MachLogRaces::apcs(MachPhys::Race r)
{
    return pDataImpl_->apcs_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::APCs& MachLogRaces::apcs(MachPhys::Race r) const
{
    return pDataImpl_->apcs_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Garrisons& MachLogRaces::garrisons(MachPhys::Race r)
{
    return pDataImpl_->garrisons_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Garrisons& MachLogRaces::garrisons(MachPhys::Race r) const
{
    return pDataImpl_->garrisons_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::HardwareLabs& MachLogRaces::hardwareLabs(MachPhys::Race r)
{
    return pDataImpl_->hardwareLabs_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::HardwareLabs& MachLogRaces::hardwareLabs(MachPhys::Race r) const
{
    return pDataImpl_->hardwareLabs_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Factories& MachLogRaces::factories(MachPhys::Race r)
{
    return pDataImpl_->factories_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Factories& MachLogRaces::factories(MachPhys::Race r) const
{
    return pDataImpl_->factories_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Smelters& MachLogRaces::smelters(MachPhys::Race r)
{
    return pDataImpl_->smelters_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Smelters& MachLogRaces::smelters(MachPhys::Race r) const
{
    return pDataImpl_->smelters_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Mines& MachLogRaces::mines(MachPhys::Race r)
{
    return pDataImpl_->mines_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Mines& MachLogRaces::mines(MachPhys::Race r) const
{
    return pDataImpl_->mines_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::MissileEmplacements& MachLogRaces::missileEmplacements(MachPhys::Race r)
{
    return pDataImpl_->missileEmplacements_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::MissileEmplacements& MachLogRaces::missileEmplacements(MachPhys::Race r) const
{
    return pDataImpl_->missileEmplacements_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Holographs& MachLogRaces::holographs(MachPhys::Race r)
{
    return pDataImpl_->holographs_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Holographs& MachLogRaces::holographs(MachPhys::Race r) const
{
    return pDataImpl_->holographs_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Beacons& MachLogRaces::beacons(MachPhys::Race r)
{
    return pDataImpl_->beacons_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Beacons& MachLogRaces::beacons(MachPhys::Race r) const
{
    return pDataImpl_->beacons_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRaces::Pods& MachLogRaces::pods(MachPhys::Race r)
{
    return pDataImpl_->pods_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Pods& MachLogRaces::pods(MachPhys::Race r) const
{
    return pDataImpl_->pods_[map_MachPhysRace_to_size_t(r)];
}

///////////////////////////////////
MachLogRaces::Artefacts& MachLogRaces::artefactsCollection()
{
    return pDataImpl_->artefactsCollection_;
}

const MachLogRaces::Artefacts& MachLogRaces::artefactsCollection() const
{
    return pDataImpl_->artefactsCollection_;
}
...
MachLogRaces::Squadrons& MachLogRaces::squadrons(MachPhys::Race r)
{
    return pDataImpl_->squadrons_[map_MachPhysRace_to_size_t(r)];
}

const MachLogRaces::Squadrons& MachLogRaces::squadrons(MachPhys::Race r) const
{
    return pDataImpl_->squadrons_[map_MachPhysRace_to_size_t(r)];
}
...
bool MachLogRaces::freeSquadron(MachPhys::Race r, MachLogSquadron** ppSquadron)
{
    for (Squadrons::iterator i = pDataImpl_->squadrons_[map_MachPhysRace_to_size_t(r)].begin();
         i != pDataImpl_->squadrons_[map_MachPhysRace_to_size_t(r)].end();
         ++i)
...
int MachLogRaces::nConstructions(MachPhys::Race r) const
{
    return pDataImpl_->nConstructions_[map_MachPhysRace_to_size_t(r)];
}

int MachLogRaces::nMachines(MachPhys::Race r) const
{
    return pDataImpl_->nMachines_[map_MachPhysRace_to_size_t(r)];
}

MachPhys::BuildingMaterialUnits MachLogRaces::nBuildingMaterialUnits(MachPhys::Race r) const
{
    return pDataImpl_->nBuildingMaterialUnits_[map_MachPhysRace_to_size_t(r)];
}

MachPhys::BuildingMaterialUnits MachLogRaces::nOre(MachPhys::Race r) const
{
    return pDataImpl_->nOre_[map_MachPhysRace_to_size_t(r)];
}

MachPhys::BuildingMaterialUnits MachLogRaces::nMaxBuildingMaterialUnits(MachPhys::Race r) const
{
    return pDataImpl_->nMaxBuildingMaterialUnits_[map_MachPhysRace_to_size_t(r)];
}

MachPhys::BuildingMaterialUnits MachLogRaces::nMaxOre(MachPhys::Race r) const
{
    return pDataImpl_->nMaxOre_[map_MachPhysRace_to_size_t(r)];
}

MachPhys::BuildingMaterialUnits
MachLogRaces::smartAddBMUs(MachPhys::Race r, MachPhys::BuildingMaterialUnits amountToAdd)
{
    PRE(amountToAdd >= 0);
...
MachPhys::BuildingMaterialUnits
MachLogRaces::smartSubtractBMUs(MachPhys::Race r, MachPhys::BuildingMaterialUnits amountToSubtract)
{
...
MachPhys::BuildingMaterialUnits
MachLogRaces::reduceCapacityWithPenalty(MachPhys::Race r, MachPhys::BuildingMaterialUnits amountReducedBy)
{
...
MachPhys::BuildingMaterialUnits
MachLogRaces::reduceCapacityNoPenalty(MachPhys::Race r, MachPhys::BuildingMaterialUnits amountReducedBy)
{
    PRE(amountReducedBy <= nMaxBuildingMaterialUnits(r));
...
// these variables will be altered as and when needed by the various MLclasses as needed
int& MachLogRaces::nConstructions(MachPhys::Race r)
{
    return pDataImpl_->nConstructions_[map_MachPhysRace_to_size_t(r)];
}

int& MachLogRaces::nMachines(MachPhys::Race r)
{
    return pDataImpl_->nMachines_[map_MachPhysRace_to_size_t(r)];
}

void MachLogRaces::nBuildingMaterialUnits(MachPhys::Race r, MachPhys::BuildingMaterialUnits newValue)
{
    PRE(newValue >= 0);
...
MachPhys::BuildingMaterialUnits& MachLogRaces::nOre(MachPhys::Race r)
{
    return pDataImpl_->nOre_[map_MachPhysRace_to_size_t(r)];
}

MachPhys::BuildingMaterialUnits& MachLogRaces::nMaxBuildingMaterialUnits(MachPhys::Race r)
{
    return pDataImpl_->nMaxBuildingMaterialUnits_[map_MachPhysRace_to_size_t(r)];
}

MachPhys::BuildingMaterialUnits& MachLogRaces::nMaxOre(MachPhys::Race r)
{
    return pDataImpl_->nMaxOre_[map_MachPhysRace_to_size_t(r)];
}
...
MachLogRace& MachLogRaces::race(MachPhys::Race r)
{
    return (r == MachPhys::NORACE ? *pDataImpl_->pNoRaceRace_ : *pDataImpl_->race_[map_MachPhysRace_to_size_t(r)]);
}

void MachLogRaces::race(MachPhys::Race r, MachLogRace* pRace, MachLogRaces::CreateDefaultSquadrons doCreate)
{
...
MachLogController& MachLogRaces::controller(MachPhys::Race r)
{
    return *pDataImpl_->controller_[map_MachPhysRace_to_size_t(r)];
}

void MachLogRaces::setController(MachPhys::Race r, MachLogController* pCtl)
{
    pDataImpl_->controller_[map_MachPhysRace_to_size_t(r)] = pCtl;
}

const MachLogController& MachLogRaces::controller(MachPhys::Race r) const
{
    return *pDataImpl_->controller_[map_MachPhysRace_to_size_t(r)];
}
...
template <class CONTAINER, class T> void races_ctl_erase(CONTAINER* cPtr, const T& t)
{
...
bool MachLogRaces::findTargetClosestTo(
    const MachActor& actor,
    MachActor** ppResult,
...
bool MachLogRaces::findFriendlyClosestTo(
    const MachActor& actor,
    MachActor** ppResult,
    MachLog::TargetSystemType targetSystemType,
...
int MachLogRaces::findSafestFriendly(const MachActor& actor, MachActor** ppResult, SafeActorType safeActorType)
{
                ...
                case AGGRESSIVE_MACHINES:
                    {
                        ...
                        for (Aggressors::const_iterator i = aggressors(ridx).begin(); i != aggressors(ridx).end(); ++i)
                        {
                            ...
                            // note that one cannot select an already-evading machine as a "safest machine". As well as
                        ...
                        for (Administrators::const_iterator i = administrators(ridx).begin();
                             i != administrators(ridx).end();
                             ++i)
                        {
                            int candidateSafetyValue = (*i)->localStrengthFromPosition(pos);
...
void MachLogRaces::allFriendlyAggressiveMachinesWithinRange(
...
void MachLogRaces::allFriendlyAggressivesWithinRange(
    const MachActor* pActor,
    MATHEX_SCALAR range,
    ctl_pvector<MachActor>* pActors,
    MATHEX_SCALAR minRange)
...
bool MachLogRaces::findFriendlyGarrisonClosestTo(
    const MachLogMachine& machine,
    MachLogGarrison** ppGarrison,
    MachPhysStation** ppStation,
    MachLogRaces::FindGarrisonCriterion criterion)
{
...
void MachLogRaces::addToAllCollections(MachActor* pActor)
{
    ...
    */
    ...
    {
        case MachLog::ADMINISTRATOR:
            administrators(pActor->race()).push_back(&pActor->asAdministrator());
            break;
        case MachLog::AGGRESSOR:
            aggressors(pActor->race()).push_back(&pActor->asAggressor());
            break;
        case MachLog::APC:
            APCs(pActor->race()).push_back(&pActor->asAPC());
            break;
        case MachLog::CONSTRUCTOR:
            {
                MachLogConstructor& constructor = pActor->asConstructor();
                constructors(pActor->race()).push_back(&constructor);
                constructionTree().updateAvailableConstructions(
                    constructor.race(),
            ...
            break;
        case MachLog::GEO_LOCATOR:
            geoLocators(pActor->race()).push_back(&pActor->asGeoLocator());
            break;
        case MachLog::RESOURCE_CARRIER:
            resourceCarriers(pActor->race()).push_back(&pActor->asResourceCarrier());
            break;
        case MachLog::TECHNICIAN:
            ...
            break;
        case MachLog::SPY_LOCATOR:
            spyLocators(pActor->race()).push_back(&pActor->asSpyLocator());
            break;
        case MachLog::BEACON:
            beacons(pActor->race()).push_back(&pActor->asBeacon());
            break;
        case MachLog::FACTORY:
            factories(pActor->race()).push_back(&pActor->asFactory());
            break;
        case MachLog::GARRISON:
            garrisons(pActor->race()).push_back(&pActor->asGarrison());
            break;
        case MachLog::HARDWARE_LAB:
            hardwareLabs(pActor->race()).push_back(&pActor->asHardwareLab());
            break;
        case MachLog::MINE:
            mines(pActor->race()).push_back(&pActor->asMine());
            break;
        case MachLog::MISSILE_EMPLACEMENT:
            missileEmplacements(pActor->race()).push_back(&pActor->asMissileEmplacement());
            break;
        case MachLog::SMELTER:
            smelters(pActor->race()).push_back(&pActor->asSmelter());
            break;
        case MachLog::POD:
            pods(pActor->race()).push_back(&pActor->asPod());
            break;
        case MachLog::ARTEFACT:
            artefactsCollection().push_back(&pActor->asArtefact());
            break;
    }
}
...
void MachLogRaces::cascadeUpdateForResearch(MachPhys::Race race)
{
    ...
    for (HardwareLabs::iterator i = pDataImpl_->hardwareLabs_[race].begin(); i != pDataImpl_->hardwareLabs_[race].end();
         ++i)
            ...
            if (raceInGame(r))
            {
                ...
                for (Objects::iterator i = raceObjects(r).begin(); i != raceObjects(r).end(); ++i)
                {
                    if ((*i)->objectIsConstruction())
                    {
                        ...
                        o << c.objectType() << " " << c.level() << " " << c.position().x() << " " << c.position().y()
                          << " " << c.position().z() << " ";
                ...
                for (Objects::iterator i = raceObjects(r).begin(); i != raceObjects(r).end(); ++i)
                {
                    if ((*i)->objectIsMachine())
                    {
                        ...
                        o << m.objectType() << " " << m.hwLevel() << " " << m.swLevel() << " " << m.position().x()
...
{
    PRE(pDataImpl_->pResearchTree_ == nullptr);
    PRE(pDataImpl_->pConstructionTree_ == nullptr);
...
void MachLogRaces::clear()
{
    ...
    for (size_t i = 0; i != MachPhys::N_RACES; ++i)
    {
        ...
        pDataImpl_->race_[i] = nullptr;
        pDataImpl_->controller_[i] = nullptr;
        pDataImpl_->thePCController_ = nullptr;

        // Clear away the list of assembly points
        if (pDataImpl_->aggressorAssemblyPoints_[i].size() != 0)
            pDataImpl_->aggressorAssemblyPoints_[i].erase(
                pDataImpl_->aggressorAssemblyPoints_[i].begin(),
                pDataImpl_->aggressorAssemblyPoints_[i].end());

        if (pDataImpl_->administratorAssemblyPoints_[i].size() != 0)
            pDataImpl_->administratorAssemblyPoints_[i].erase(
                pDataImpl_->administratorAssemblyPoints_[i].begin(),
...
void MachLogRaces::actorDestroyedScoreAdjust(
    MachPhys::Race losingRace,
    int value,
    const MachActor& actor,
    MachPhys::Race gainingRace)
{
...
std::ostream& operator<<(std::ostream& o, const MachLogRaces::SafeActorType& actorType)
{
    switch (actorType)
    {
        case MachLogRaces::AGGRESSIVE_MACHINES:
            o << "AGGRESSIVE_MACHINES";
            break;
        case MachLogRaces::MISSILE_EMPLACEMENTS:
            o << "MISSILE_EMPLACEMENTS";
            break;
        case MachLogRaces::GARRISONS:
            o << "GARRISONS";
            break;
        case MachLogRaces::PODS:
            o << "PODS";
            break;
        case MachLogRaces::AGGRESSIVE_MACHINES_AND_MISSILE_EMPLACEMENTS:
            o << "AGGRESSIVE_MACHINES_AND_MISSILE_EMPLACEMENTS";
            break;
    }
    return o;
}
...
bool MachLogRaces::findAlternativeTargetClosestTo(
    const MachActor& actor,
    MachActor** ppResult,
    MATHEX_SCALAR minEuclidianDistance) const
{
    ...
    for (MachPhys::Race ridx = MachPhys::RED; ridx != MachPhys::N_RACES; ++((int&)ridx))
    {
        ...
        if (disp != MachLogRaces::ALLY and disp != MachLogRaces::OUR_RACE)
        {
            ...
            for (ResourceCarriers::const_iterator i = resourceCarriers(ridx).begin(); i != resourceCarriers(ridx).end();
                 ++i)
            {
                MachActor* pTargetActor = (*i);
...
void MachLogRaces::specialActorUpdate()
{
    ...
    for (Objects::iterator i = toBeRemovedFromSpecialUpdateActors.begin();
         i != toBeRemovedFromSpecialUpdateActors.end();
         ++i)
        removeSpecialUpdateActor(*i, MachLog::FORCE_REMOVE);

    toBeRemovedFromSpecialUpdateActors.erase(
        toBeRemovedFromSpecialUpdateActors.begin(),
        toBeRemovedFromSpecialUpdateActors.end());
    //  ostream& out = W4dManager::instance().sceneManager()->out();
    //  out << "Special Update Actors " << specialUpdateActors.size() << std::endl;
    //  for( Objects::iterator i = specialUpdateActors.begin(); i != specialUpdateActors.end(); ++i)
    //  {
    //      out << (*i)->id() << " " << (*i)->objectType() << " startTime " << (*i)->startTimeInSpecialUpdateActors() <<
    //      " maxTime " << (*i)->maximumTimeInSpecialUpdateActors() << std::endl;
    //  }
...
{
    return pDataImpl_->pDatabaseHandler_ != nullptr;
}
...
bool MachLogRaces::findMostValuableTarget(
    const MachActor& actor,
    MachActor** ppResult,
    MachLog::TargetSystemType targetSystemType,
    MachLog::ObjectType ot,
...
int MachLogRaces::nCompleteConstructions(MachPhys::Race r, MachLog::ObjectType type) const
{
    ...
    switch (type)
    {
        ...
        case MachLog::MISSILE_EMPLACEMENT:
            {
                for (MissileEmplacements::const_iterator i = missileEmplacements(r).begin();
                     i != missileEmplacements(r).end();
                     ++i)
                    if ((*i)->isComplete())
                        ++result;
                break;
...
void MachLogRaces::constructionsBuiltScoreAdjust(
    MachPhys::Race buildingRace,
...
void MachLogRaces::unregisterDispositionChangeNotifiable(MachLogDispositionChangeNotifiable* pNotifiable)
{
    ...
    MachLogRacesDataImpl::DispositionNotifiables& notifiables = pDataImpl_->dispositionNotifiables_;
    MachLogRacesDataImpl::DispositionNotifiables::iterator i
        = find(notifiables.begin(), notifiables.end(), pNotifiable);
...
std::ostream& operator<<(std::ostream& o, MachLogRaces::DispositionToRace d)
{
    switch (d)
    {
        case MachLogRaces::OUR_RACE:
            o << "OUR_RACE";
            break;
        case MachLogRaces::ALLY:
            o << "ALLY";
            break;
        case MachLogRaces::NEUTRAL:
            o << "NEUTRAL";
            break;
        case MachLogRaces::ENEMY:
            o << "ENEMY";
            break;
    }
    return o;
...
MachLogRaces::DispositionToRace
MachLogRaces::dispositionToRace(const MachPhys::Race checkRace, const MachPhys::Race targetRace) const
{
...
void MachLogRaces::dispositionToRace(
    const MachPhys::Race checkRace,
    const MachPhys::Race targetRace,
    MachLogRaces::DispositionToRace newDisposition)
{
    DispositionToRace oldDisposition
        = pDataImpl_->disposition_[map_MachPhysRace_to_size_t(checkRace)][map_MachPhysRace_to_size_t(targetRace)];
    HAL_STREAM(
        "MachLogRaces::dispositionToRace " << checkRace << " to " << targetRace << " new Disposition " << newDisposition
                                           << " old " << oldDisposition << std::endl);
    pDataImpl_->disposition_[map_MachPhysRace_to_size_t(checkRace)][map_MachPhysRace_to_size_t(targetRace)]
        = newDisposition;
    MachLogRacesDataImpl::DispositionNotifiables& notifiables = pDataImpl_->dispositionNotifiables_;
    if (oldDisposition != newDisposition)
    {
        ...
        for (MachLogRacesDataImpl::DispositionNotifiables::iterator i = notifiables.begin(); i != notifiables.end();
             ++i)
        {
...
void MachLogRaces::dispositionToRaceWithoutEcho(
    const MachPhys::Race checkRace,
    const MachPhys::Race targetRace,
    DispositionToRace newDisposition)
{
    DispositionToRace oldDisposition
        = pDataImpl_->disposition_[map_MachPhysRace_to_size_t(checkRace)][map_MachPhysRace_to_size_t(targetRace)];
    HAL_STREAM(
        "MachLogRaces::dispositionToRaceWithoutEcho " << checkRace << " to " << targetRace << " new Disposition "
                                                      << newDisposition << " old " << oldDisposition << std::endl);
    pDataImpl_->disposition_[map_MachPhysRace_to_size_t(checkRace)][map_MachPhysRace_to_size_t(targetRace)]
        = newDisposition;
    MachLogRacesDataImpl::DispositionNotifiables& notifiables = pDataImpl_->dispositionNotifiables_;
    if (oldDisposition != newDisposition)
...
MachPhys::BuildingMaterialUnits
MachLogRaces::increaseRaceCapacity(MachPhys::Race r, MachPhys::BuildingMaterialUnits amountIncreasedBy)
{
