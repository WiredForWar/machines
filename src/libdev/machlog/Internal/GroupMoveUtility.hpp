...
public:
    ...
    CTL_TRIPLE(Clump, Machines, machines, MexPoint2d, centroid, MATHEX_SCALAR, radius);
...
private:
    ...
    void calculateCentroidAndRadius(const Machines& actors, MexPoint2d* pCentroid, MATHEX_SCALAR* pRadius) const;
