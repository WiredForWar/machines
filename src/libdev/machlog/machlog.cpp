...
std::ostream& operator<<(std::ostream& o, const MachLog::RandomStarts& randomStarts)
{
    switch (randomStarts)
    {
        case MachLog::RANDOM_START_LOCATIONS:
            o << "RANDOM_START_LOCATIONS";
            break;
        case MachLog::FIXED_START_LOCATIONS:
            o << "FIXED_START_LOCATIONS";
            break;
    }
    return o;
}
...
std::ostream& operator<<(std::ostream& o, const MachLog::PlayerType& playerType)
{
    switch (playerType)
    {
        case MachLog::PC_LOCAL:
            o << "PC_LOCAL";
            break;
        case MachLog::PC_REMOTE:
            o << "PC_REMOTE";
            break;
        case MachLog::AI_LOCAL:
            o << "AI_LOCAL";
            break;
        case MachLog::AI_REMOTE:
            o << "AI_REMOTE";
            break;
        case MachLog::NOT_DEFINED:
            o << "NOT_DEFINED";
            break;
    }
    return o;
...
std::ostream& operator<<(std::ostream& o, const MachLog::VictoryCondition& victory)
{
    switch (victory)
    {
        case MachLog::VICTORY_DEFAULT:
            o << "VICTORY_DEFAULT";
            break;
        case MachLog::VICTORY_ANNIHILATION:
            o << "VICTORY_ANNIHILATION";
            break;
...
std::ostream& operator<<(std::ostream& o, const MachLog::GameType& t)
{
    switch (t)
    {
        case MachLog::CAMPAIGN_SINGLE_PLAYER:
            o << "CAMPAIGN_SINGLE_PLAYER";
            break;
        case MachLog::SKIRMISH_SINGLE_PLAYER:
            o << "SKIRMISH_SINGLE_PLAYER";
            break;
        case MachLog::MULTIPLAYER:
            o << "MULTIPLAYER";
            break;
    }
    return o;
