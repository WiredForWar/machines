...
std::ostream& operator<<(std::ostream& o, const MachLogLargeMissile& t)
{

    o << "MachLogLargeMissile " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachLogLargeMissile " << static_cast<const void*>(&t) << " end" << std::endl;
