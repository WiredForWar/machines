...
public:
    ...
    enum OperationType
    {
        ...
        ATTACK_OPERATION,
        FOLLOW_OPERATION,
        SEEK_AND_DESTROY_OPERATION,
        ANIMATION,
        ADMIN_ATTACK_OPERATION,
        ADMIN_CONSTRUCT_OPERATION,
        ADMIN_HEAL_OPERATION,
        ADMIN_LOCATE_OPERATION,
        CAPTURE_OPERATION,
        CONSTRUCT_OPERATION,
        DEPLOY_APC_OPERATION,
        ENTER_APC_OPERATION,
        GOTO_LAB_OPERATION,
        HEAL_OPERATION,
        DROPLANDMINE_OPERATION,
        LOCATE_OPERATION,
        MISSILE_EMPLACEMENT_ATTACK_OPERATION,
        PICKUP_OPERATION,
        POD_ATTACK_OPERATION,
        PUTDOWN_OPERATION,
        REFILLLANDMINES_OPERATION,
        REPAIR_OPERATION,
        TRANSPORT_OPERATION,
        TREACHERY_OPERATION,
        TASK_ATTACK_OPERATION,
        TASK_CONSTRUCT_OPERATION,
        TASK_DROPLANDMINE_OPERATION,
        TASK_LOCATE_OPERATION,
        PATROL_OPERATION,
        ENTER_OPERATION,
        LEAVE_OPERATION,
        MOVE_AND_TURN_OPERATION,
        DECONSTRUCT_OPERATION,
        RECYCLE_OPERATION,
        ADMIN_DECONSTRUCT_OPERATION,
        ADMIN_CAPTURE_OPERATION,
        SUPERCONSTRUCT_OPERATION,
        ADMIN_SUPERCONSTRUCT_OPERATION,
        STAND_GROUND_OPERATION,
        ADMIN_REPAIR_OPERATION,
        EVADE_OPERATION,
        CAMO_MOVE_OPERATION,
        NUKE_ATTACK_OPERATION,
        TASK_PATROL_OPERATION,
        SCAVENGE_OPERATION,
        COUNTERATTACK_OPERATION,
        AUTOSCAVENGE_OPERATION,
        N_OPERATIONS
    };
