...
class MachLogResourceCarrier : public MachLogMachine // ,
//  public MachLogCanPickUp,
//  public MachLogCanPutDown
// cannonical form revoked
{
public:
    using Suppliers = ctl_pvector<MachLogConstruction>;

    enum SpecialIterations
    {
        FOREVER = -1
    };
    enum StartWithPickUpOrPutDown
    {
        START_WITH_PUTDOWN,
        START_WITH_PICKUP
    };
...
private:
    ...
    static MachPhysResourceCarrier*
    pNewPhysResourceCarrier(Level hwLevel, Level swLevel, MachLogRace* pRace, const MexPoint3d& location);
