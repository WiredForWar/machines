...
struct MachLog
{
    ...
    enum Message : unsigned char
    {
        ...
        PERCENTAGE_COMPLETE_CHANGED, // Sent by constructions when they are being built - particularly for benefit of
                                     // status bars
        WEAPON_AVAILABILITY_CHANGED, // Used by actors with weapons that become available dynamically and/or have large
                                     // recharge times
        MINE_CHANGED_OPERATIONAL_STATUS, // Sent by mines when they have either exhausted a mineral site when previously
                                         // active or found a new mineral source when dormant
    ...
    enum SelectableType : unsigned char
    {
        NOT_SELECTABLE,
        FULLY_SELECTABLE
    };
    ...
    enum RandomStarts : unsigned char
    {
    ...
    enum StartingResources : unsigned char
    {
        ...
        STARTING_RESOURCES_RES_LOW,
        STARTING_RESOURCES_MEDIUM,
        STARTING_RESOURCES_HIGH,
