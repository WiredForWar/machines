...
public:
    ...
    {
        NOT_IN_DISTANCE_RANGE,
        NOT_IN_HORIZONTAL_ANGLE_RANGE,
        NOT_IN_VERTICAL_ANGLE_RANGE,
        BEHIND_COVER,
        BEHIND_FRIENDLY_COVER,
        IN_RANGE
    };
    ...
    static WeaponDisposition testActorBehindCover(
...
protected:
    ...
    // for mobiles
    void checkAndAttackCloserTarget(MachLogMachine*, MachActor* pFiredAtMe = nullptr);
...
private:
    ...
    improveAimInterval(); // interval from last firing time within which aim is improved from previous shot
