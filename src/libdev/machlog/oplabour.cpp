...
PhysRelativeTime MachLogLabourOperation::doUpdate()
{
    ...
    if (pSubOperation())
    {
        ...
        if (hasBuildPoint_)
        {
            ...
            MATHEX_SCALAR sqrAcceptableDistance
        ...
        case MOVING:
            {
                ...
                else
                {
                    ...
                    MexTransform3d constructionPointAsTransform
                        = MachLogSpacialManipulation::sourceToDestination3dTransform(
                            pConstruction()->position(),
                            buildPointPosition,
                    ...
                    else
                    {
                        ...
                        subOperation(
                            pActor_,
                            _NEW(MachLogMoveAndTurnOperation(pActor_, actualBuildPosition, constructionPosition)));
                    }
                }
            }
            break;
...
bool MachLogLabourOperation::constructorFacingBuilding() const
{
    ...
    MexRadians absTempRelativeAngle
        = fabs(MachLogSpacialManipulation::angleToTurnToFace(*pActor_, constructionCentre).asScalar());
...
// virtual
bool MachLogLabourOperation::beNotified(W4dSubject* pSubject, W4dSubject::NotificationEvent event, int clientData)
{
    CB_MachLogLabourOperation_DEPIMPL();
