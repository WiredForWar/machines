...
public:
    ...
    ~MachLog1stPersonMachineHandler() override;
...
private:
    ...
    void doUpdateMaxWeaponRange(MATHEX_SCALAR range) override;

    // FP COMMAND - Get the active squadron
    const MachLog1stPersonActiveSquadron& actuallyGetActiveSquadron() const override;
