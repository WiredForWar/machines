...
#include "machlog/Combat/LightSting.hpp"
...
std::ostream& operator<<(std::ostream& o, const MachLogLightStingWeapon& t)
{

    o << "MachLogLightStingWeapon " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachLogLightStingWeapon " << static_cast<const void*>(&t) << " end" << std::endl;
