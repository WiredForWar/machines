...
std::ostream& operator<<(std::ostream& o, const MachLogSquadronImpl& t)
{

    o << "MachLogSquadronImpl " << static_cast<const void*>(&t) << " start" << std::endl;
    o << "MachLogSquadronImpl " << static_cast<const void*>(&t) << " end" << std::endl;
