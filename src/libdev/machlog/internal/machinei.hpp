...
private:
    ...
    bool rampaging_; // used by task attack to keep track of which squadron machines have actually set off intoo the
                     // world from their assembly points
};
