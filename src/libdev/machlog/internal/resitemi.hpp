...
private:
    friend std::ostream& operator<<(std::ostream& o, const MachLogResearchItemImpl& t);
    ...
    MachPhys::ResearchUnits swAmountResearched_[MachLogResearchItem::N_RESEARCH_RACES]
                                               [MachLogResearchItem::MAX_SW_LEVELS];
    MachPhys::BuildingMaterialUnits swAmountBuilt_[MachLogResearchItem::N_RESEARCH_RACES]
                                                  [MachLogResearchItem::MAX_SW_LEVELS];
