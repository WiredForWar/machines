...
set(TOOLCHAIN_EXTRA_FLAGS "-Wl,-Bstatic -lstdc++ -lpthread -Wl,-Bdynamic")

set(CMAKE_C_STANDARD_LIBRARIES "${TOOLCHAIN_EXTRA_FLAGS} ${CMAKE_C_STANDARD_LIBRARIES}")
set(CMAKE_CXX_STANDARD_LIBRARIES "${TOOLCHAIN_EXTRA_FLAGS} ${CMAKE_CXX_STANDARD_LIBRARIES}")
